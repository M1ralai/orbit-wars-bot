...
BASE_PARAMS = {
    "min_ships": 16,
    "min_reserve": 16,
    "reserve_prod_mult": 2.8359,
    "panic_reserve_mult": 0.7492,
    "neutral_bonus": 20,
    "neutral_tax": 2,
    "enemy_bonus": 37,
    "enemy_weak_bonus": 0.2417,
    "counter_bonus": 11,
    "pressure_max": 14,
    "pressure_divisor": 29,
    ...
    "high_prod_tax": 9,
    "distance_weight": 2.5126,
    "high_distance_weight": 2.0,
    "short_hop_bonus": 1.1914,
    "short_hop_range": 24,
    "ship_weight": 1.0299,
    "high_ship_weight": 1.0231,
    "overkill": 3,
    "high_prod_extra": 5,
    "enemy_extra": 11,
    ...
    "comet_bonus": 13,
    "staging_penalty": 17.7149,
    "defense_worth_factor": 10.0,
    "counter_attack_bonus": 17.9234,
    "production_forecast_mult": 0.9524,
    "evac_eta_threshold": 2.5673,
    "evac_minor_prod": 1,
    "sync_max_eta": 10.0,
