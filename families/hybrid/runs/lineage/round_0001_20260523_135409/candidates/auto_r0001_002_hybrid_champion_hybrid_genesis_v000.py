...
BASE_PARAMS = {
    "min_ships": 14,
    "min_reserve": 2,
    "reserve_prod_mult": 2.2341,
    "panic_reserve_mult": 0.8624,
    "neutral_bonus": 24,
    "neutral_tax": 2,
    "enemy_bonus": 34,
    "enemy_weak_bonus": 0.3572,
    "counter_bonus": 11,
    "pressure_max": 14,
    "pressure_divisor": 35,
    ...
    "high_prod_tax": 6,
    "distance_weight": 2.4036,
    "high_distance_weight": 1.9658,
    "short_hop_bonus": 0.8782,
    "short_hop_range": 27,
    "ship_weight": 1.05,
    ...
    "high_prod_extra": 4,
    "enemy_extra": 1,
    "attack_fraction": 0.8098,
    "max_attacks_per_turn": 5,
    "comet_bonus": 12,
    "staging_penalty": 14.4362,
    "defense_worth_factor": 10.6644,
    "counter_attack_bonus": 18.5311,
    "production_forecast_mult": 1.0,
    "evac_eta_threshold": 3.2227,
    "evac_minor_prod": 1,
    "sync_max_eta": 10.0,
