...
BASE_PARAMS = {
    "min_ships": 12,
    "min_reserve": 3,
    "reserve_prod_mult": 2.1731,
    "panic_reserve_mult": 0.7799,
    "neutral_bonus": 20,
    "neutral_tax": 3,
    "enemy_bonus": 40,
    "enemy_weak_bonus": 3.9208,
    "counter_bonus": 17,
    "pressure_max": 13,
    "pressure_divisor": 33,
    ...
    "high_prod_extra": 2,
    "enemy_extra": 9,
    "attack_fraction": 0.9268,
    "max_attacks_per_turn": 5,
    "comet_bonus": 13,
    "staging_penalty": 14.8586,
    "defense_worth_factor": 9.3804,
    "counter_attack_bonus": 20.0,
    "production_forecast_mult": 1.0,
    "evac_eta_threshold": 2.8646,
    "evac_minor_prod": 3,
    "sync_max_eta": 11.8449,
