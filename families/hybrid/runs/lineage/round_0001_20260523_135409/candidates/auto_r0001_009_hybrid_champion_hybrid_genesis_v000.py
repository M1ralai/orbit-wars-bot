...
BASE_PARAMS = {
    "min_ships": 11,
    "min_reserve": 4,
    "reserve_prod_mult": 2.2877,
    "panic_reserve_mult": 0.5263,
    "neutral_bonus": 21,
    "neutral_tax": 3,
    "enemy_bonus": 32,
    "enemy_weak_bonus": 0.632,
    "counter_bonus": 12,
    "pressure_max": 16,
    "pressure_divisor": 33,
    "production_weight": 31,
    "high_production_weight": 53,
    "high_prod_tax": 2,
    "distance_weight": 2.2516,
    "high_distance_weight": 2.0,
    "short_hop_bonus": 0.9395,
    "short_hop_range": 26,
    "ship_weight": 1.05,
    "high_ship_weight": 0.7876,
    "overkill": 3,
    "high_prod_extra": 5,
    "enemy_extra": 14,
    "attack_fraction": 0.8372,
    "max_attacks_per_turn": 6,
    "comet_bonus": 7,
    "staging_penalty": 16.9918,
    "defense_worth_factor": 10.0,
    "counter_attack_bonus": 21.1241,
    "production_forecast_mult": 0.9558,
