...
BASE_PARAMS = {
    "min_ships": 14,
    "min_reserve": 6,
    "reserve_prod_mult": 2.8943,
    "panic_reserve_mult": 0.8644,
    "neutral_bonus": 20,
    "neutral_tax": 4,
    "enemy_bonus": 35,
    ...
    "high_prod_tax": 2,
    "distance_weight": 2.0822,
    "high_distance_weight": 2.0,
    "short_hop_bonus": 0.9061,
    "short_hop_range": 22,
    "ship_weight": 1.05,
    "high_ship_weight": 0.7349,
    "overkill": 4,
    "high_prod_extra": 3,
    "enemy_extra": 10,
    "attack_fraction": 0.8498,
    "max_attacks_per_turn": 7,
    "comet_bonus": 10,
    "staging_penalty": 15.0,
    "defense_worth_factor": 9.612,
    "counter_attack_bonus": 20.0,
    "production_forecast_mult": 1.0,
    "evac_eta_threshold": 2.8923,
    "evac_minor_prod": 1,
    "sync_max_eta": 14.2184,
