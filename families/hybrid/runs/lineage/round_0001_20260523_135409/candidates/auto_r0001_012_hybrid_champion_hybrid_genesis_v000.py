...
BASE_PARAMS = {
    ...
    "panic_reserve_mult": 0.5649,
    "neutral_bonus": 24,
    "neutral_tax": 4,
    "enemy_bonus": 34,
    "enemy_weak_bonus": 0.6574,
    "counter_bonus": 11,
    "pressure_max": 18,
    "pressure_divisor": 34,
    ...
    "high_prod_tax": 3,
    "distance_weight": 2.4001,
    "high_distance_weight": 1.8601,
    "short_hop_bonus": 1.4564,
    "short_hop_range": 27,
    "ship_weight": 1.05,
    "high_ship_weight": 0.7682,
    "overkill": 3,
    "high_prod_extra": 5,
    "enemy_extra": 6,
    "attack_fraction": 0.7947,
    "max_attacks_per_turn": 9,
    "comet_bonus": 11,
    "staging_penalty": 12.5634,
    "defense_worth_factor": 8.1603,
    "counter_attack_bonus": 20.0,
    "production_forecast_mult": 1.1708,
    "evac_eta_threshold": 3.0,
    "evac_minor_prod": 2,
    "sync_max_eta": 11.0122,
