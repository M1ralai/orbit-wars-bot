...
BASE_PARAMS = {
    "min_ships": 15,
    "min_reserve": 2,
    "reserve_prod_mult": 2.312,
    "panic_reserve_mult": 0.675,
    "neutral_bonus": 24,
    "neutral_tax": 5,
    "enemy_bonus": 32,
    "enemy_weak_bonus": 1.3321,
    "counter_bonus": 10,
    "pressure_max": 15,
    "pressure_divisor": 34,
    ...
    "high_prod_tax": 5,
    "distance_weight": 2.6354,
    "high_distance_weight": 2.098,
    ...
    "high_prod_extra": 4,
    "enemy_extra": 9,
    "attack_fraction": 0.8995,
    "max_attacks_per_turn": 9,
    "comet_bonus": 13,
    "staging_penalty": 14.3592,
    "defense_worth_factor": 11.2835,
    "counter_attack_bonus": 40.8765,
    "production_forecast_mult": 0.7552,
