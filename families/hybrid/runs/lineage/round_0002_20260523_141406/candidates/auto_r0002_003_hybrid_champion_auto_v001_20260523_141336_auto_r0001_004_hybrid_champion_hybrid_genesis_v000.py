...
BASE_PARAMS = {
    ...
    "high_prod_tax": 7,
    "distance_weight": 2.2303,
    "high_distance_weight": 2.1758,
    "short_hop_bonus": 0.3123,
    "short_hop_range": 42,
    "ship_weight": 0.8304,
    "high_ship_weight": 0.8304,
    "overkill": 8,
    "high_prod_extra": 3,
    "enemy_extra": 3,
    "attack_fraction": 0.8598,
    "max_attacks_per_turn": 8,
    "comet_bonus": 10,
    "staging_penalty": 14.3121,
    "defense_worth_factor": 11.1131,
    "counter_attack_bonus": 36.9549,
    "production_forecast_mult": 0.9541,
    "evac_eta_threshold": 3.3319,
    "evac_minor_prod": 3,
    "sync_max_eta": 10.0,
