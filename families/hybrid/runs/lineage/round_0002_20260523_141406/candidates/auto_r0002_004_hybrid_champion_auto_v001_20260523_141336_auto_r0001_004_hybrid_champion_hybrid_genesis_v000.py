...
BASE_PARAMS = {
    "min_ships": 15,
    "min_reserve": 3,
    "reserve_prod_mult": 1.614,
    "panic_reserve_mult": 0.739,
    "neutral_bonus": 17,
    "neutral_tax": 5,
    "enemy_bonus": 32,
    "enemy_weak_bonus": 0.7664,
    "counter_bonus": 11,
    "pressure_max": 19,
    "pressure_divisor": 40,
    ...
    "high_prod_tax": 5,
    "distance_weight": 2.4526,
    "high_distance_weight": 1.9016,
    "short_hop_bonus": 1.1968,
    "short_hop_range": 18,
    "ship_weight": 1.05,
    ...
    "high_prod_extra": 2,
    "enemy_extra": 5,
    "attack_fraction": 0.8854,
    "max_attacks_per_turn": 9,
    "comet_bonus": 12,
    "staging_penalty": 14.3592,
    "defense_worth_factor": 8.0451,
    "counter_attack_bonus": 33.9738,
    "production_forecast_mult": 1.0374,
    "evac_eta_threshold": 2.9966,
    "evac_minor_prod": 3,
    "sync_max_eta": 10.0,
