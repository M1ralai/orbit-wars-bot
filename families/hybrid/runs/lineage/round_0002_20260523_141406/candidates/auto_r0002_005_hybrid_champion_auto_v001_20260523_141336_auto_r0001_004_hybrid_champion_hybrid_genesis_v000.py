...
BASE_PARAMS = {
    "min_ships": 16,
    "min_reserve": 7,
    "reserve_prod_mult": 1.6735,
    "panic_reserve_mult": 0.5377,
    "neutral_bonus": 24,
    "neutral_tax": 9,
    "enemy_bonus": 32,
    "enemy_weak_bonus": 1.6591,
    "counter_bonus": 11,
    "pressure_max": 18,
    "pressure_divisor": 40,
    ...
    "high_prod_tax": 0,
    "distance_weight": 2.3649,
    "high_distance_weight": 1.9567,
    "short_hop_bonus": 0.8468,
    "short_hop_range": 22,
    "ship_weight": 1.05,
    "high_ship_weight": 0.9547,
    "overkill": 8,
    "high_prod_extra": 2,
    "enemy_extra": 8,
    "attack_fraction": 0.9238,
    "max_attacks_per_turn": 6,
    "comet_bonus": 12,
    "staging_penalty": 14.3592,
    "defense_worth_factor": 9.9617,
    "counter_attack_bonus": 40.1517,
    "production_forecast_mult": 1.0884,
