...
BASE_PARAMS = {
    "min_ships": 15,
    "min_reserve": 2,
    "reserve_prod_mult": 1.6911,
    "panic_reserve_mult": 0.5603,
    "neutral_bonus": 21,
    "neutral_tax": 7,
    "enemy_bonus": 32,
    "enemy_weak_bonus": 1.6114,
    "counter_bonus": 12,
    "pressure_max": 24,
    "pressure_divisor": 34,
    ...
    "high_prod_tax": 8,
    "distance_weight": 2.3456,
    "high_distance_weight": 2.1787,
    "short_hop_bonus": 0.937,
    "short_hop_range": 18,
    "ship_weight": 1.05,
    "high_ship_weight": 0.8914,
    "overkill": 6,
    "high_prod_extra": 2,
    "enemy_extra": 8,
    "attack_fraction": 0.4817,
    "max_attacks_per_turn": 8,
    "comet_bonus": 10,
    "staging_penalty": 14.3592,
    "defense_worth_factor": 8.0456,
    "counter_attack_bonus": 36.3502,
