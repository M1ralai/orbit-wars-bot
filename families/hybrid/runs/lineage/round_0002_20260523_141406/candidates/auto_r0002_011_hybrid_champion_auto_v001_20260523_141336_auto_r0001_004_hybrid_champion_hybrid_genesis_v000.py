...
BASE_PARAMS = {
    ...
    "high_distance_weight": 2.2107,
    "short_hop_bonus": 0.8764,
    "short_hop_range": 23,
    "ship_weight": 0.8812,
    "high_ship_weight": 0.6014,
    "overkill": 6,
    "high_prod_extra": 2,
    "enemy_extra": 7,
    "attack_fraction": 0.9039,
    "max_attacks_per_turn": 6,
    "comet_bonus": 14,
    "staging_penalty": 9.7494,
    "defense_worth_factor": 11.1277,
    "counter_attack_bonus": 36.9549,
    "production_forecast_mult": 1.1372,
    "evac_eta_threshold": 5.4475,
    "evac_minor_prod": 3,
    "sync_max_eta": 10.0,
