...
BASE_PARAMS = {
    ...
    "panic_reserve_mult": 1.6539,
    "neutral_bonus": 23,
    "neutral_tax": 7,
    "enemy_bonus": 34,
    "enemy_weak_bonus": 1.6602,
    "counter_bonus": 8,
    "pressure_max": 21,
    "pressure_divisor": 36,
    ...
    "high_prod_tax": 10,
    "distance_weight": 2.09,
    "high_distance_weight": 2.09,
    "short_hop_bonus": 0.8509,
    "short_hop_range": 20,
    "ship_weight": 0.9521,
    "high_ship_weight": 0.8128,
    "overkill": 8,
    "high_prod_extra": 5,
    "enemy_extra": 9,
    "attack_fraction": 0.9219,
    "max_attacks_per_turn": 8,
    "comet_bonus": 16,
    "staging_penalty": 13.8377,
    "defense_worth_factor": 9.6643,
    "counter_attack_bonus": 33.6126,
    "production_forecast_mult": 0.5994,
    "evac_eta_threshold": 3.2579,
    "evac_minor_prod": 3,
    "sync_max_eta": 8.8531,
