...
BASE_PARAMS = {
    "min_ships": 20,
    "min_reserve": 2,
    "reserve_prod_mult": 1.7651,
    "panic_reserve_mult": 0.6582,
    "neutral_bonus": 23,
    "neutral_tax": 6,
    "enemy_bonus": 31,
    "enemy_weak_bonus": 0.839,
    "counter_bonus": 9,
    "pressure_max": 53,
    "pressure_divisor": 34,
    ...
    "high_prod_tax": 6,
    "distance_weight": 2.2772,
    "high_distance_weight": 2.2711,
    "short_hop_bonus": 0.8644,
    "short_hop_range": 24,
    "ship_weight": 1.231,
    "high_ship_weight": 0.5843,
    "overkill": 7,
    "high_prod_extra": 5,
    "enemy_extra": 9,
    ...
    "comet_bonus": 12,
    "staging_penalty": 16.065,
    "defense_worth_factor": 10.1071,
    "counter_attack_bonus": 36.9549,
    "production_forecast_mult": 0.9541,
    "evac_eta_threshold": 3.1794,
    "evac_minor_prod": 1,
    "sync_max_eta": 5.1026,
