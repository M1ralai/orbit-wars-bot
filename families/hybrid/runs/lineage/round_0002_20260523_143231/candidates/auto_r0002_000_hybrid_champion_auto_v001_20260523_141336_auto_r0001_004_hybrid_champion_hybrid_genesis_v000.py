...
BASE_PARAMS = {
    "min_ships": 17,
    "min_reserve": 3,
    "reserve_prod_mult": 2.251,
    "panic_reserve_mult": 0.675,
    "neutral_bonus": 23,
    "neutral_tax": 12,
    "enemy_bonus": 34,
    "enemy_weak_bonus": 1.1497,
    "counter_bonus": 10,
    "pressure_max": 19,
    "pressure_divisor": 35,
    ...
    "high_prod_tax": 6,
    "distance_weight": 2.0433,
    "high_distance_weight": 1.739,
    "short_hop_bonus": 1.2071,
    "short_hop_range": 41,
    "ship_weight": 1.1201,
    "high_ship_weight": 0.7566,
    "overkill": 8,
    "high_prod_extra": 5,
    "enemy_extra": 3,
    "attack_fraction": 0.8333,
    "max_attacks_per_turn": 3,
    "comet_bonus": 12,
    "staging_penalty": 14.3592,
    "defense_worth_factor": 9.9617,
    "counter_attack_bonus": 38.1952,
    "production_forecast_mult": 0.9541,
    "evac_eta_threshold": 3.2765,
    "evac_minor_prod": 3,
    "sync_max_eta": 11.1094,
    "sync_min_target_prod": 2,
    "sync_min_target_ships": 27,
    "snipe_max_step": 92,
    "snipe_overkill": 1,
    "honeypot_min_prod": 4,
    "honeypot_reserve": 6,
