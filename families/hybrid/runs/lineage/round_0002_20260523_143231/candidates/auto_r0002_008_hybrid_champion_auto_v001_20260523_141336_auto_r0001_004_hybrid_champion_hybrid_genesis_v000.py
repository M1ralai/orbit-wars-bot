...
BASE_PARAMS = {
    ...
    "panic_reserve_mult": 0.7695,
    "neutral_bonus": 28,
    "neutral_tax": 4,
    "enemy_bonus": 31,
    "enemy_weak_bonus": 1.2167,
    "counter_bonus": 11,
    "pressure_max": 19,
    "pressure_divisor": 36,
    ...
    "high_prod_tax": 8,
    "distance_weight": 2.1978,
    "high_distance_weight": 2.1978,
    "short_hop_bonus": 0.8468,
    "short_hop_range": 21,
    "ship_weight": 1.1965,
    "high_ship_weight": 0.8655,
    "overkill": 7,
    "high_prod_extra": 5,
    "enemy_extra": 7,
    "attack_fraction": 0.8571,
    "max_attacks_per_turn": 5,
    "comet_bonus": 10,
    "staging_penalty": 13.7755,
    "defense_worth_factor": 9.9617,
    "counter_attack_bonus": 37.977,
    "production_forecast_mult": 0.7676,
    "evac_eta_threshold": 2.4942,
    "evac_minor_prod": 1,
    "sync_max_eta": 13.5532,
