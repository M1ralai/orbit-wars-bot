...
BASE_PARAMS = {
    ...
    "high_prod_extra": 2,
    "enemy_extra": 6,
    "attack_fraction": 0.8087,
    "max_attacks_per_turn": 4,
    "comet_bonus": 12,
    "staging_penalty": 17.6242,
    "defense_worth_factor": 8.6043,
    "counter_attack_bonus": 40.965,
    "production_forecast_mult": 0.9541,
    "evac_eta_threshold": 3.3012,
    "evac_minor_prod": 1,
    "sync_max_eta": 10.8197,
