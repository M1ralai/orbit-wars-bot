...
BASE_PARAMS = {
    ...
    "panic_reserve_mult": 0.804,
    "neutral_bonus": 23,
    "neutral_tax": 4,
    "enemy_bonus": 31,
    "enemy_weak_bonus": 1.6199,
    "counter_bonus": 11,
    "pressure_max": 24,
    "pressure_divisor": 37,
    ...
    "high_prod_tax": 6,
    "distance_weight": 2.0564,
    "high_distance_weight": 2.0,
    "short_hop_bonus": 0.4631,
    "short_hop_range": 24,
    "ship_weight": 0.8907,
    ...
    "high_prod_extra": 5,
    "enemy_extra": 9,
    "attack_fraction": 0.882,
    "max_attacks_per_turn": 7,
    "comet_bonus": 9,
    "staging_penalty": 12.0197,
    "defense_worth_factor": 9.9617,
    "counter_attack_bonus": 38.503,
    "production_forecast_mult": 0.8576,
    "evac_eta_threshold": 3.4267,
    "evac_minor_prod": 3,
    "sync_max_eta": 8.458,
    "sync_min_target_prod": 2,
    "sync_min_target_ships": 29,
    "snipe_max_step": 90,
    "snipe_overkill": 3,
    "honeypot_min_prod": 2,
    "honeypot_reserve": 5,
