...
BASE_PARAMS = {
    ...
    "panic_reserve_mult": 0.725,
    "neutral_bonus": 25,
    "neutral_tax": 9,
    "enemy_bonus": 27,
    "enemy_weak_bonus": 0.9263,
    "counter_bonus": 14,
    "pressure_max": 19,
    "pressure_divisor": 34,
    ...
    "high_prod_tax": 10,
    "distance_weight": 2.2415,
    "high_distance_weight": 2.0551,
    "short_hop_bonus": 0.0,
    "short_hop_range": 17,
    "ship_weight": 1.1065,
    "high_ship_weight": 0.8772,
    "overkill": 6,
    "high_prod_extra": 4,
    "enemy_extra": 6,
    "attack_fraction": 0.9026,
    "max_attacks_per_turn": 3,
    "comet_bonus": 12,
    "staging_penalty": 15.4552,
    "defense_worth_factor": 11.1321,
    "counter_attack_bonus": 36.9549,
    "production_forecast_mult": 0.9827,
    "evac_eta_threshold": 2.9935,
    "evac_minor_prod": 3,
    "sync_max_eta": 8.3198,
