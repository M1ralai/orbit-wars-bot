...
BASE_PARAMS = {
    ...
    "panic_reserve_mult": 0.9637,
    "neutral_bonus": 31,
    "neutral_tax": 9,
    "enemy_bonus": 28,
    "enemy_weak_bonus": 1.1141,
    "counter_bonus": 18,
    "pressure_max": 22,
    "pressure_divisor": 37,
    ...
    "high_prod_tax": 2,
    "distance_weight": 2.5834,
    "high_distance_weight": 1.8407,
    "short_hop_bonus": 0.1556,
    "short_hop_range": 16,
    "ship_weight": 1.3747,
    "high_ship_weight": 0.8144,
    "overkill": 3,
    "high_prod_extra": 5,
    "enemy_extra": 14,
    ...
    "comet_bonus": 11,
    "staging_penalty": 10.5144,
    "defense_worth_factor": 11.6056,
    "counter_attack_bonus": 36.9549,
    "production_forecast_mult": 0.9219,
    "evac_eta_threshold": 3.4109,
    "evac_minor_prod": 3,
    "sync_max_eta": 9.6044,
