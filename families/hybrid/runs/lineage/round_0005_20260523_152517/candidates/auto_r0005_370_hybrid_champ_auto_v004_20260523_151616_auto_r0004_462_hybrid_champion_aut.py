...
BASE_PARAMS = {
    "min_ships": 20,
    "min_reserve": 2,
    "reserve_prod_mult": 1.5854,
    "panic_reserve_mult": 1.0653,
    "neutral_bonus": 25,
    "neutral_tax": 7,
    "enemy_bonus": 27,
    "enemy_weak_bonus": 1.3531,
    "counter_bonus": 12,
    "pressure_max": 23,
    "pressure_divisor": 40,
    ...
    "high_distance_weight": 2.0676,
    "short_hop_bonus": 0.0,
    "short_hop_range": 16,
    "ship_weight": 1.2071,
    "high_ship_weight": 0.5078,
    "overkill": 6,
    "high_prod_extra": 5,
    "enemy_extra": 0,
    "attack_fraction": 0.9185,
    "max_attacks_per_turn": 6,
    "comet_bonus": 7,
    "staging_penalty": 11.2678,
    "defense_worth_factor": 11.1321,
    "counter_attack_bonus": 36.9549,
    "production_forecast_mult": 0.427,
    "evac_eta_threshold": 3.0835,
    "evac_minor_prod": 3,
    "sync_max_eta": 10.3275,
