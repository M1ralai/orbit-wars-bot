...
BASE_PARAMS = {
    ...
    "high_prod_extra": 5,
    "enemy_extra": 9,
    "attack_fraction": 0.9035,
    "max_attacks_per_turn": 1,
    "comet_bonus": 16,
    "staging_penalty": 11.876,
    "defense_worth_factor": 10.6993,
    "counter_attack_bonus": 38.3579,
    "production_forecast_mult": 1.0715,
    "evac_eta_threshold": 2.7458,
    "evac_minor_prod": 3,
    "sync_max_eta": 8.7991,
