...
BASE_PARAMS = {
    ...
    "panic_reserve_mult": 0.8038,
    "neutral_bonus": 28,
    "neutral_tax": 11,
    "enemy_bonus": 25,
    "enemy_weak_bonus": 3.8003,
    "counter_bonus": 16,
    "pressure_max": 21,
    "pressure_divisor": 41,
    ...
    "high_prod_tax": 4,
    "distance_weight": 2.2852,
    "high_distance_weight": 1.9399,
    "short_hop_bonus": 0.2817,
    "short_hop_range": 16,
    "ship_weight": 1.2837,
    "high_ship_weight": 0.7591,
    "overkill": 6,
    "high_prod_extra": 3,
    "enemy_extra": 5,
    "attack_fraction": 0.9536,
    "max_attacks_per_turn": 3,
    "comet_bonus": 15,
    "staging_penalty": 12.9486,
    "defense_worth_factor": 11.1321,
    "counter_attack_bonus": 35.4176,
    "production_forecast_mult": 1.0673,
    "evac_eta_threshold": 2.5854,
    "evac_minor_prod": 1,
    "sync_max_eta": 7.4359,
