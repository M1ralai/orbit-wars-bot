...
BASE_PARAMS = {
    ...
    "panic_reserve_mult": 0.6543,
    "neutral_bonus": 25,
    "neutral_tax": 9,
    "enemy_bonus": 24,
    "enemy_weak_bonus": 1.4365,
    "counter_bonus": 16,
    "pressure_max": 19,
    "pressure_divisor": 40,
    ...
    "high_prod_tax": 4,
    "distance_weight": 2.207,
    "high_distance_weight": 1.9688,
    "short_hop_bonus": 0.2817,
    "short_hop_range": 17,
    "ship_weight": 0.5905,
    "high_ship_weight": 0.5905,
    "overkill": 3,
    "high_prod_extra": 0,
    "enemy_extra": 9,
    ...
    "comet_bonus": 14,
    "staging_penalty": 31.4752,
    "defense_worth_factor": 11.0751,
    "counter_attack_bonus": 36.9549,
    "production_forecast_mult": 1.0891,
    "evac_eta_threshold": 2.742,
    "evac_minor_prod": 3,
    "sync_max_eta": 8.7991,
