...
BASE_PARAMS = {
    ...
    "panic_reserve_mult": 0.9681,
    "neutral_bonus": 28,
    "neutral_tax": 11,
    "enemy_bonus": 32,
    "enemy_weak_bonus": 1.0756,
    "counter_bonus": 16,
    "pressure_max": 17,
    "pressure_divisor": 37,
    ...
    "high_prod_tax": 2,
    "distance_weight": 2.6305,
    "high_distance_weight": 2.1866,
    "short_hop_bonus": 0.0715,
    "short_hop_range": 17,
    "ship_weight": 1.2486,
    "high_ship_weight": 0.6665,
    "overkill": 1,
    "high_prod_extra": 2,
    "enemy_extra": 4,
    "attack_fraction": 0.9023,
    "max_attacks_per_turn": 2,
    "comet_bonus": 15,
    "staging_penalty": 14.6865,
    "defense_worth_factor": 10.1532,
    "counter_attack_bonus": 37.8363,
    "production_forecast_mult": 1.1427,
    "evac_eta_threshold": 3.0835,
    "evac_minor_prod": 2,
    "sync_max_eta": 12.3354,
