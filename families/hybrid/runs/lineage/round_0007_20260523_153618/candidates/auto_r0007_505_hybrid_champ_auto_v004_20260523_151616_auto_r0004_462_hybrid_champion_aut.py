...
BASE_PARAMS = {
    ...
    "panic_reserve_mult": 1.0463,
    "neutral_bonus": 28,
    "neutral_tax": 9,
    "enemy_bonus": 25,
    "enemy_weak_bonus": 1.3867,
    "counter_bonus": 15,
    "pressure_max": 21,
    "pressure_divisor": 37,
    ...
    "high_prod_tax": 2,
    "distance_weight": 2.2776,
    "high_distance_weight": 1.5039,
    ...
    "high_prod_extra": 5,
    "enemy_extra": 3,
    "attack_fraction": 0.8415,
    "max_attacks_per_turn": 3,
    "comet_bonus": 15,
    "staging_penalty": 11.876,
    "defense_worth_factor": 11.1321,
    "counter_attack_bonus": 38.9578,
    "production_forecast_mult": 0.9333,
    "evac_eta_threshold": 2.8882,
    "evac_minor_prod": 3,
    "sync_max_eta": 9.2822,
