...
BASE_PARAMS = {
    ...
    "panic_reserve_mult": 1.0024,
    "neutral_bonus": 25,
    "neutral_tax": 6,
    "enemy_bonus": 26,
    "enemy_weak_bonus": 1.5587,
    "counter_bonus": 16,
    "pressure_max": 17,
    "pressure_divisor": 34,
    ...
    "high_prod_tax": 3,
    "distance_weight": 2.2328,
    "high_distance_weight": 1.7935,
    "short_hop_bonus": 0.4672,
    "short_hop_range": 19,
    "ship_weight": 1.3839,
    "high_ship_weight": 0.561,
    "overkill": 5,
    "high_prod_extra": 1,
    "enemy_extra": 6,
    "attack_fraction": 0.855,
    "max_attacks_per_turn": 4,
    "comet_bonus": 14,
    "staging_penalty": 11.0176,
    "defense_worth_factor": 9.7779,
    "counter_attack_bonus": 36.9549,
    "production_forecast_mult": 1.1752,
    "evac_eta_threshold": 2.7386,
    "evac_minor_prod": 1,
    "sync_max_eta": 8.7991,
