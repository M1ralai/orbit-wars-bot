...
BASE_PARAMS = {
    ...
    "panic_reserve_mult": 0.8025,
    "neutral_bonus": 31,
    "neutral_tax": 10,
    "enemy_bonus": 23,
    "enemy_weak_bonus": 3.2331,
    "counter_bonus": 16,
    "pressure_max": 23,
    "pressure_divisor": 37,
    ...
    "high_distance_weight": 1.7078,
    "short_hop_bonus": 0.225,
    "short_hop_range": 17,
    "ship_weight": 1.1411,
    "high_ship_weight": 0.7754,
    "overkill": 3,
    "high_prod_extra": 0,
    "enemy_extra": 5,
    ...
    "comet_bonus": 9,
    "staging_penalty": 8.8454,
    "defense_worth_factor": 9.9303,
    "counter_attack_bonus": 36.9549,
    "production_forecast_mult": 0.9504,
    "evac_eta_threshold": 3.1244,
    "evac_minor_prod": 2,
    "sync_max_eta": 8.6763,
