...
BASE_PARAMS = {
    ...
    "panic_reserve_mult": 0.6882,
    "neutral_bonus": 28,
    "neutral_tax": 8,
    "enemy_bonus": 22,
    "enemy_weak_bonus": 1.4172,
    "counter_bonus": 17,
    "pressure_max": 20,
    "pressure_divisor": 37,
    ...
    "high_prod_tax": 4,
    "distance_weight": 2.7902,
    "high_distance_weight": 1.8166,
    "short_hop_bonus": 0.0044,
    "short_hop_range": 17,
    "ship_weight": 1.3766,
    "high_ship_weight": 0.8279,
    "overkill": 4,
    "high_prod_extra": 5,
    "enemy_extra": 8,
    "attack_fraction": 0.875,
    "max_attacks_per_turn": 1,
    "comet_bonus": 12,
    "staging_penalty": 11.876,
    "defense_worth_factor": 10.7998,
    "counter_attack_bonus": 32.4257,
    "production_forecast_mult": 1.1528,
    "evac_eta_threshold": 3.0971,
    "evac_minor_prod": 3,
    "sync_max_eta": 8.7991,
    "sync_min_target_prod": 1,
    "sync_min_target_ships": 25,
    "snipe_max_step": 86,
    "snipe_overkill": 1,
    "honeypot_min_prod": 3,
    "honeypot_reserve": 6,
