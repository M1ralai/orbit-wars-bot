...
BASE_PARAMS = {
    ...
    "panic_reserve_mult": 1.0035,
    "neutral_bonus": 25,
    "neutral_tax": 12,
    "enemy_bonus": 32,
    "enemy_weak_bonus": 1.5635,
    "counter_bonus": 16,
    "pressure_max": 21,
    "pressure_divisor": 40,
    ...
    "high_distance_weight": 2.1676,
    "short_hop_bonus": 0.2817,
    "short_hop_range": 17,
    "ship_weight": 1.2486,
    "high_ship_weight": 0.71,
    "overkill": 3,
    "high_prod_extra": 5,
    "enemy_extra": 7,
    "attack_fraction": 0.9007,
    "max_attacks_per_turn": 2,
    "comet_bonus": 13,
    "staging_penalty": 11.3369,
    "defense_worth_factor": 10.9138,
    "counter_attack_bonus": 36.9549,
    "production_forecast_mult": 0.8976,
    "evac_eta_threshold": 3.375,
    "evac_minor_prod": 1,
    "sync_max_eta": 8.7991,
