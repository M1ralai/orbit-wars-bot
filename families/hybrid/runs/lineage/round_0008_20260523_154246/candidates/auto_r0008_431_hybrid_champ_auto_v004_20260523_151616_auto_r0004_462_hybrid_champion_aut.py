...
BASE_PARAMS = {
    ...
    "high_prod_tax": 6,
    "distance_weight": 2.167,
    "high_distance_weight": 1.7057,
    "short_hop_bonus": 0.3126,
    "short_hop_range": 16,
    "ship_weight": 1.2486,
    "high_ship_weight": 0.9905,
    "overkill": 6,
    "high_prod_extra": 3,
    "enemy_extra": 12,
    "attack_fraction": 0.9682,
    "max_attacks_per_turn": 2,
    "comet_bonus": 13,
    "staging_penalty": 14.8519,
    "defense_worth_factor": 11.1321,
    "counter_attack_bonus": 41.2624,
    "production_forecast_mult": 1.2606,
    "evac_eta_threshold": 2.9323,
    "evac_minor_prod": 2,
    "sync_max_eta": 8.7991,
