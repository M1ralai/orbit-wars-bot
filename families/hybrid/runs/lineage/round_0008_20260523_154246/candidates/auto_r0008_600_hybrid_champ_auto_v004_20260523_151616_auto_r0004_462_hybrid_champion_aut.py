...
BASE_PARAMS = {
    ...
    "panic_reserve_mult": 0.6541,
    "neutral_bonus": 32,
    "neutral_tax": 12,
    "enemy_bonus": 29,
    "enemy_weak_bonus": 1.4927,
    "counter_bonus": 13,
    "pressure_max": 18,
    "pressure_divisor": 35,
    ...
    "high_distance_weight": 1.8652,
    "short_hop_bonus": 0.2853,
    "short_hop_range": 16,
    "ship_weight": 1.2486,
    "high_ship_weight": 0.6087,
    "overkill": 5,
    "high_prod_extra": 3,
    "enemy_extra": 6,
    "attack_fraction": 0.9675,
    "max_attacks_per_turn": 2,
    "comet_bonus": 15,
    "staging_penalty": 11.876,
    "defense_worth_factor": 11.1321,
    "counter_attack_bonus": 40.6503,
    "production_forecast_mult": 0.9801,
    "evac_eta_threshold": 3.392,
    "evac_minor_prod": 1,
    "sync_max_eta": 8.7991,
