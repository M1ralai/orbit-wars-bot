...
BASE_PARAMS = {
    ...
    "panic_reserve_mult": 0.8057,
    "neutral_bonus": 31,
    "neutral_tax": 3,
    "enemy_bonus": 27,
    "enemy_weak_bonus": 0.9942,
    "counter_bonus": 16,
    "pressure_max": 19,
    "pressure_divisor": 34,
    ...
    "high_prod_tax": 7,
    "distance_weight": 2.7649,
    "high_distance_weight": 2.1241,
    "short_hop_bonus": 0.2817,
    "short_hop_range": 17,
    "ship_weight": 1.3714,
    "high_ship_weight": 0.8423,
    "overkill": 3,
    "high_prod_extra": 3,
    "enemy_extra": 9,
    ...
    "comet_bonus": 13,
    "staging_penalty": 15.1111,
    "defense_worth_factor": 10.002,
    "counter_attack_bonus": 40.3158,
    "production_forecast_mult": 1.0616,
    "evac_eta_threshold": 2.7044,
    "evac_minor_prod": 3,
    "sync_max_eta": 8.7991,
