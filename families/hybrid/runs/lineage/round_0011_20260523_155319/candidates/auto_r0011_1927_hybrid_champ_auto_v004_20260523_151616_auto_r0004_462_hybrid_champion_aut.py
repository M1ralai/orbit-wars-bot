...
BASE_PARAMS = {
    ...
    "panic_reserve_mult": 0.9743,
    "neutral_bonus": 28,
    "neutral_tax": 8,
    "enemy_bonus": 28,
    "enemy_weak_bonus": 1.52,
    "counter_bonus": 16,
    "pressure_max": 20,
    "pressure_divisor": 40,
    ...
    "high_prod_tax": 2,
    "distance_weight": 2.593,
    "high_distance_weight": 2.0905,
    "short_hop_bonus": 0.5494,
    "short_hop_range": 17,
    "ship_weight": 1.3706,
    ...
    "high_prod_extra": 4,
    "enemy_extra": 6,
    "attack_fraction": 0.9717,
    "max_attacks_per_turn": 1,
    "comet_bonus": 12,
    "staging_penalty": 14.5242,
    "defense_worth_factor": 9.7302,
    "counter_attack_bonus": 36.9549,
    "production_forecast_mult": 1.0616,
    "evac_eta_threshold": 3.0791,
    "evac_minor_prod": 3,
    "sync_max_eta": 8.7991,
