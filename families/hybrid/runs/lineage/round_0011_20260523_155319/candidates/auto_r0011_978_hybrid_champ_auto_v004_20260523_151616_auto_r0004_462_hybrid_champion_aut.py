...
BASE_PARAMS = {
    ...
    "panic_reserve_mult": 0.751,
    "neutral_bonus": 26,
    "neutral_tax": 7,
    "enemy_bonus": 27,
    "enemy_weak_bonus": 1.2033,
    "counter_bonus": 16,
    "pressure_max": 11,
    "pressure_divisor": 37,
    ...
    "high_prod_tax": 42,
    "distance_weight": 2.6453,
    "high_distance_weight": 1.8115,
    "short_hop_bonus": 0.3977,
    "short_hop_range": 16,
    "ship_weight": 1.0714,
    "high_ship_weight": 0.5643,
    "overkill": 5,
    "high_prod_extra": 1,
    "enemy_extra": 6,
    "attack_fraction": 0.9583,
    "max_attacks_per_turn": 1,
    "comet_bonus": 13,
    "staging_penalty": 12.2899,
    "defense_worth_factor": 12.5513,
    "counter_attack_bonus": 41.114,
    "production_forecast_mult": 0.9422,
    "evac_eta_threshold": 3.0636,
    "evac_minor_prod": 3,
    "sync_max_eta": 9.1282,
