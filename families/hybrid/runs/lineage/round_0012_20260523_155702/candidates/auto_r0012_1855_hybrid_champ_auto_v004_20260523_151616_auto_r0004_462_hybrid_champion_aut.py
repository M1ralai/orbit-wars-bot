...
BASE_PARAMS = {
    "min_ships": 20,
    "min_reserve": 2,
    "reserve_prod_mult": 1.5732,
    "panic_reserve_mult": 0.8745,
    "neutral_bonus": 26,
    "neutral_tax": 9,
    "enemy_bonus": 23,
    ...
    "high_distance_weight": 1.8977,
    "short_hop_bonus": 0.685,
    "short_hop_range": 16,
    "ship_weight": 1.2486,
    ...
    "comet_bonus": 15,
    "staging_penalty": 11.667,
    "defense_worth_factor": 9.4094,
    "counter_attack_bonus": 36.9549,
    "production_forecast_mult": 1.0163,
    "evac_eta_threshold": 3.2748,
    "evac_minor_prod": 3,
    "sync_max_eta": 8.7991,
    "sync_min_target_prod": 1,
    "sync_min_target_ships": 20,
    "snipe_max_step": 87,
    "snipe_overkill": 1,
    "honeypot_min_prod": 3,
    "honeypot_reserve": 8,
