...
BASE_PARAMS = {
    ...
    "panic_reserve_mult": 1.0517,
    "neutral_bonus": 31,
    "neutral_tax": 9,
    "enemy_bonus": 20,
    "enemy_weak_bonus": 3.7262,
    "counter_bonus": 12,
    "pressure_max": 18,
    "pressure_divisor": 43,
    ...
    "high_prod_tax": 4,
    "distance_weight": 2.1657,
    "high_distance_weight": 2.1657,
    "short_hop_bonus": 0.0,
    "short_hop_range": 16,
    "ship_weight": 1.127,
    "high_ship_weight": 0.7358,
    "overkill": 2,
    "high_prod_extra": 3,
    "enemy_extra": 6,
    "attack_fraction": 0.9467,
    "max_attacks_per_turn": 4,
    "comet_bonus": 18,
    "staging_penalty": 14.3499,
    "defense_worth_factor": 9.5405,
    "counter_attack_bonus": 39.0718,
    "production_forecast_mult": 1.0616,
    "evac_eta_threshold": 3.3428,
    "evac_minor_prod": 3,
    "sync_max_eta": 9.239,
