...
BASE_PARAMS = {
    ...
    "panic_reserve_mult": 0.8907,
    "neutral_bonus": 25,
    "neutral_tax": 8,
    "enemy_bonus": 25,
    "enemy_weak_bonus": 2.1601,
    "counter_bonus": 16,
    "pressure_max": 19,
    "pressure_divisor": 37,
    ...
    "high_prod_tax": 6,
    "distance_weight": 2.6674,
    "high_distance_weight": 2.0233,
    ...
    "high_prod_extra": 3,
    "enemy_extra": 8,
    "attack_fraction": 0.8742,
    "max_attacks_per_turn": 1,
    "comet_bonus": 17,
    "staging_penalty": 15.1379,
    "defense_worth_factor": 11.1321,
    "counter_attack_bonus": 38.802,
    "production_forecast_mult": 0.9096,
    "evac_eta_threshold": 3.4791,
    "evac_minor_prod": 3,
    "sync_max_eta": 8.1992,
