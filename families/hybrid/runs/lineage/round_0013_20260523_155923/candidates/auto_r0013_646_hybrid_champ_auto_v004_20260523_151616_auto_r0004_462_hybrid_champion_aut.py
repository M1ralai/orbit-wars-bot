...
BASE_PARAMS = {
    ...
    "panic_reserve_mult": 0.9385,
    "neutral_bonus": 5,
    "neutral_tax": 7,
    "enemy_bonus": 23,
    "enemy_weak_bonus": 1.2056,
    "counter_bonus": 19,
    "pressure_max": 23,
    "pressure_divisor": 39,
    ...
    "high_prod_tax": 2,
    "distance_weight": 2.1857,
    "high_distance_weight": 1.9142,
    "short_hop_bonus": 0.7096,
    "short_hop_range": 16,
    "ship_weight": 1.4209,
    "high_ship_weight": 0.5913,
    "overkill": 6,
    "high_prod_extra": 0,
    "enemy_extra": 9,
    "attack_fraction": 0.9379,
    "max_attacks_per_turn": 2,
    "comet_bonus": 12,
    "staging_penalty": 13.5417,
    "defense_worth_factor": 10.1146,
    "counter_attack_bonus": 34.0653,
    "production_forecast_mult": 1.0729,
    "evac_eta_threshold": 1.9859,
    "evac_minor_prod": 3,
    "sync_max_eta": 8.7991,
