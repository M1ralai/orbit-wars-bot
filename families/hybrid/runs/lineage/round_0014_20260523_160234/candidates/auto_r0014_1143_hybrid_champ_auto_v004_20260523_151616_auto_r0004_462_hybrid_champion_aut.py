...
BASE_PARAMS = {
    ...
    "panic_reserve_mult": 0.882,
    "neutral_bonus": 25,
    "neutral_tax": 9,
    "enemy_bonus": 24,
    "enemy_weak_bonus": 1.0509,
    "counter_bonus": 17,
    "pressure_max": 20,
    "pressure_divisor": 37,
    ...
    "high_prod_tax": 2,
    "distance_weight": 2.3337,
    "high_distance_weight": 1.7636,
    "short_hop_bonus": 0.0,
    "short_hop_range": 16,
    "ship_weight": 1.2486,
    "high_ship_weight": 0.6124,
    "overkill": 3,
    "high_prod_extra": 3,
    "enemy_extra": 6,
    ...
    "comet_bonus": 16,
    "staging_penalty": 10.9413,
    "defense_worth_factor": 5.8919,
    "counter_attack_bonus": 36.9549,
    "production_forecast_mult": 1.0616,
    "evac_eta_threshold": 2.6994,
    "evac_minor_prod": 1,
    "sync_max_eta": 8.3724,
