...
BASE_PARAMS = {
    ...
    "high_distance_weight": 1.9088,
    "short_hop_bonus": 0.0374,
    "short_hop_range": 20,
    "ship_weight": 1.2891,
    "high_ship_weight": 0.5827,
    "overkill": 3,
    "high_prod_extra": 0,
    "enemy_extra": 9,
    "attack_fraction": 0.946,
    "max_attacks_per_turn": 1,
    "comet_bonus": 14,
    "staging_penalty": 15.1091,
    "defense_worth_factor": 10.4109,
    "counter_attack_bonus": 36.9549,
    "production_forecast_mult": 0.9715,
    "evac_eta_threshold": 3.0436,
    "evac_minor_prod": 1,
    "sync_max_eta": 8.7991,
