...
BASE_PARAMS = {
    "min_ships": 20,
    "min_reserve": 2,
    "reserve_prod_mult": 2.0002,
    "panic_reserve_mult": 0.7401,
    "neutral_bonus": 25,
    "neutral_tax": 8,
    "enemy_bonus": 23,
    "enemy_weak_bonus": 1.4945,
    "counter_bonus": 15,
    "pressure_max": 20,
    "pressure_divisor": 43,
    ...
    "high_prod_tax": 4,
    "distance_weight": 2.6675,
    "high_distance_weight": 2.0468,
    "short_hop_bonus": 0.6067,
    "short_hop_range": 18,
    "ship_weight": 1.0833,
    ...
    "high_prod_extra": 0,
    "enemy_extra": 6,
    "attack_fraction": 0.8931,
    "max_attacks_per_turn": 4,
    "comet_bonus": 10,
    "staging_penalty": 14.4599,
    "defense_worth_factor": 10.6113,
    "counter_attack_bonus": 36.9549,
    "production_forecast_mult": 1.141,
    "evac_eta_threshold": 3.4786,
    "evac_minor_prod": 1,
    "sync_max_eta": 9.1965,
