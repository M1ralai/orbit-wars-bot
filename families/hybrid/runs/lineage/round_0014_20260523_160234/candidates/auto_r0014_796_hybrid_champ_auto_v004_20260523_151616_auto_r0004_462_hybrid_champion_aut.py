...
BASE_PARAMS = {
    ...
    "panic_reserve_mult": 0.8464,
    "neutral_bonus": 27,
    "neutral_tax": 12,
    "enemy_bonus": 27,
    "enemy_weak_bonus": 0.8111,
    "counter_bonus": 14,
    "pressure_max": 23,
    "pressure_divisor": 35,
    ...
    "high_prod_tax": 1,
    "distance_weight": 2.4014,
    "high_distance_weight": 1.8908,
    "short_hop_bonus": 0.2817,
    "short_hop_range": 16,
    "ship_weight": 1.0664,
    "high_ship_weight": 0.7654,
    "overkill": 6,
    "high_prod_extra": 2,
    "enemy_extra": 9,
    "attack_fraction": 0.8906,
    "max_attacks_per_turn": 2,
    "comet_bonus": 15,
    "staging_penalty": 13.0398,
    "defense_worth_factor": 11.1321,
    "counter_attack_bonus": 34.4861,
    "production_forecast_mult": 1.1331,
    "evac_eta_threshold": 2.7585,
    "evac_minor_prod": 3,
    "sync_max_eta": 8.7991,
