...
BASE_PARAMS = {
    "min_ships": 20,
    "min_reserve": 2,
    "reserve_prod_mult": 4.57,
    "panic_reserve_mult": 0.8678,
    "neutral_bonus": 25,
    "neutral_tax": 11,
    "enemy_bonus": 23,
    "enemy_weak_bonus": 1.4962,
    "counter_bonus": 19,
    "pressure_max": 24,
    "pressure_divisor": 38,
    ...
    "high_prod_tax": 35,
    "distance_weight": 2.6519,
    "high_distance_weight": 1.7873,
    ...
    "high_prod_extra": 2,
    "enemy_extra": 8,
    "attack_fraction": 0.9641,
    "max_attacks_per_turn": 3,
    "comet_bonus": 13,
    "staging_penalty": 11.876,
    "defense_worth_factor": 10.6544,
    "counter_attack_bonus": 36.9549,
    "production_forecast_mult": 0.867,
    "evac_eta_threshold": 3.339,
    "evac_minor_prod": 2,
    "sync_max_eta": 6.9741,
