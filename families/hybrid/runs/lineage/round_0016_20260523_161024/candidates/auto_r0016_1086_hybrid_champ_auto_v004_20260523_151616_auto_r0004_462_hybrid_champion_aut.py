...
BASE_PARAMS = {
    ...
    "high_prod_tax": 5,
    "distance_weight": 2.3039,
    "high_distance_weight": 2.1296,
    "short_hop_bonus": 0.2817,
    "short_hop_range": 16,
    "ship_weight": 1.3721,
    "high_ship_weight": 0.8089,
    "overkill": 4,
    "high_prod_extra": 3,
    "enemy_extra": 5,
    "attack_fraction": 0.9051,
    "max_attacks_per_turn": 2,
    "comet_bonus": 13,
    "staging_penalty": 13.978,
    "defense_worth_factor": 8.4127,
    "counter_attack_bonus": 38.8098,
    "production_forecast_mult": 1.0616,
    "evac_eta_threshold": 2.7141,
    "evac_minor_prod": 3,
    "sync_max_eta": 8.7991,
