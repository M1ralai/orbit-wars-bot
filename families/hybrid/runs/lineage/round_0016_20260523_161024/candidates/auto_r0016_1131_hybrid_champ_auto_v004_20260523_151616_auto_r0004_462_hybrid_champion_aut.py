...
BASE_PARAMS = {
    "min_ships": 20,
    "min_reserve": 3,
    "reserve_prod_mult": 1.9522,
    "panic_reserve_mult": 0.8846,
    "neutral_bonus": 29,
    "neutral_tax": 6,
    "enemy_bonus": 28,
    "enemy_weak_bonus": 0.9641,
    "counter_bonus": 17,
    "pressure_max": 24,
    "pressure_divisor": 37,
    ...
    "high_prod_tax": 8,
    "distance_weight": 2.8339,
    "high_distance_weight": 2.0056,
    ...
    "high_prod_extra": 3,
    "enemy_extra": 6,
    "attack_fraction": 0.9168,
    "max_attacks_per_turn": 6,
    "comet_bonus": 13,
    "staging_penalty": 11.876,
    "defense_worth_factor": 11.1599,
    "counter_attack_bonus": 36.8081,
    "production_forecast_mult": 1.2594,
    "evac_eta_threshold": 3.1279,
    "evac_minor_prod": 3,
    "sync_max_eta": 9.2175,
