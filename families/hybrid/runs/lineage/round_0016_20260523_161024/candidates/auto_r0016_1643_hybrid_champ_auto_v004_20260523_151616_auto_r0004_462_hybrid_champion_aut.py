...
BASE_PARAMS = {
    "min_ships": 20,
    "min_reserve": 3,
    "reserve_prod_mult": 1.5817,
    "panic_reserve_mult": 0.6644,
    "neutral_bonus": 28,
    "neutral_tax": 7,
    "enemy_bonus": 27,
    "enemy_weak_bonus": 1.2567,
    "counter_bonus": 20,
    "pressure_max": 22,
    "pressure_divisor": 37,
    ...
    "high_prod_tax": 4,
    "distance_weight": 3.7162,
    "high_distance_weight": 1.8022,
    ...
    "high_prod_extra": 3,
    "enemy_extra": 3,
    "attack_fraction": 0.9075,
    "max_attacks_per_turn": 2,
    "comet_bonus": 10,
    "staging_penalty": 15.024,
    "defense_worth_factor": 9.7297,
    "counter_attack_bonus": 36.9549,
    "production_forecast_mult": 1.0616,
    "evac_eta_threshold": 5.7347,
    "evac_minor_prod": 3,
    "sync_max_eta": 8.7991,
