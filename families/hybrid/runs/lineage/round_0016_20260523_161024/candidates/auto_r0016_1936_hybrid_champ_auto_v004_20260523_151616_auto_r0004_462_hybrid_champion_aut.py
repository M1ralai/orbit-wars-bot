...
BASE_PARAMS = {
    ...
    "panic_reserve_mult": 1.2312,
    "neutral_bonus": 28,
    "neutral_tax": 10,
    "enemy_bonus": 28,
    "enemy_weak_bonus": 1.4233,
    "counter_bonus": 17,
    "pressure_max": 17,
    "pressure_divisor": 40,
    ...
    "high_prod_tax": 4,
    "distance_weight": 2.8135,
    "high_distance_weight": 1.8908,
    "short_hop_bonus": 0.2817,
    "short_hop_range": 16,
    "ship_weight": 1.4223,
    "high_ship_weight": 0.5394,
    "overkill": 3,
    "high_prod_extra": 5,
    "enemy_extra": 4,
    "attack_fraction": 0.9013,
    "max_attacks_per_turn": 2,
    "comet_bonus": 14,
    "staging_penalty": 15.1201,
    "defense_worth_factor": 11.1321,
    "counter_attack_bonus": 33.4497,
    "production_forecast_mult": 1.0616,
    "evac_eta_threshold": 3.5346,
    "evac_minor_prod": 1,
    "sync_max_eta": 9.9802,
