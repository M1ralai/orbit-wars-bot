...
BASE_PARAMS = {
    ...
    "panic_reserve_mult": 1.7679,
    "neutral_bonus": 25,
    "neutral_tax": 9,
    "enemy_bonus": 26,
    "enemy_weak_bonus": 2.3643,
    "counter_bonus": 16,
    "pressure_max": 24,
    "pressure_divisor": 34,
    ...
    "high_prod_tax": 2,
    "distance_weight": 2.8083,
    "high_distance_weight": 1.7943,
    "short_hop_bonus": 0.2964,
    "short_hop_range": 16,
    "ship_weight": 1.1314,
    "high_ship_weight": 0.8343,
    "overkill": 3,
    "high_prod_extra": 3,
    "enemy_extra": 5,
    "attack_fraction": 0.9029,
    "max_attacks_per_turn": 2,
    "comet_bonus": 15,
    "staging_penalty": 12.3683,
    "defense_worth_factor": 12.9066,
    "counter_attack_bonus": 32.2659,
    "production_forecast_mult": 1.0616,
    "evac_eta_threshold": 3.5772,
    "evac_minor_prod": 3,
    "sync_max_eta": 7.26,
