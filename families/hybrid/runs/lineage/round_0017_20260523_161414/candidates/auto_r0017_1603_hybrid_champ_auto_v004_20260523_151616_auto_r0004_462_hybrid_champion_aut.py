...
BASE_PARAMS = {
    ...
    "panic_reserve_mult": 0.9857,
    "neutral_bonus": 25,
    "neutral_tax": 5,
    "enemy_bonus": 52,
    "enemy_weak_bonus": 1.3149,
    "counter_bonus": 13,
    "pressure_max": 18,
    "pressure_divisor": 37,
    ...
    "high_prod_tax": 5,
    "distance_weight": 2.5044,
    "high_distance_weight": 2.0148,
    "short_hop_bonus": 0.2817,
    "short_hop_range": 16,
    "ship_weight": 1.2486,
    "high_ship_weight": 0.5401,
    "overkill": 4,
    "high_prod_extra": 0,
    "enemy_extra": 5,
    "attack_fraction": 0.8417,
    "max_attacks_per_turn": 5,
    "comet_bonus": 13,
    "staging_penalty": 9.5967,
    "defense_worth_factor": 9.5619,
    "counter_attack_bonus": 38.2122,
    "production_forecast_mult": 1.098,
    "evac_eta_threshold": 3.501,
    "evac_minor_prod": 1,
    "sync_max_eta": 8.3126,
