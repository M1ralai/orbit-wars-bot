...
BASE_PARAMS = {
    "min_ships": 20,
    "min_reserve": 4,
    "reserve_prod_mult": 1.5449,
    "panic_reserve_mult": 0.8678,
    "neutral_bonus": 28,
    "neutral_tax": 9,
    "enemy_bonus": 27,
    "enemy_weak_bonus": 0.7351,
    "counter_bonus": 17,
    "pressure_max": 21,
    "pressure_divisor": 38,
    ...
    "high_prod_tax": 3,
    "distance_weight": 2.8065,
    "high_distance_weight": 1.8908,
    "short_hop_bonus": 0.4473,
    "short_hop_range": 16,
    "ship_weight": 1.2481,
    "high_ship_weight": 0.5976,
    "overkill": 3,
    "high_prod_extra": 3,
    "enemy_extra": 8,
    "attack_fraction": 0.9609,
    "max_attacks_per_turn": 2,
    "comet_bonus": 16,
    "staging_penalty": 11.876,
    "defense_worth_factor": 10.3475,
    "counter_attack_bonus": 36.9549,
    "production_forecast_mult": 0.9085,
    "evac_eta_threshold": 3.0611,
    "evac_minor_prod": 3,
    "sync_max_eta": 9.4099,
