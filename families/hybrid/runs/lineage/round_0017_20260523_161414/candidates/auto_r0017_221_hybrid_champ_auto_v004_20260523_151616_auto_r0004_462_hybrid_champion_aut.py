...
BASE_PARAMS = {
    "min_ships": 20,
    "min_reserve": 3,
    "reserve_prod_mult": 1.7992,
    "panic_reserve_mult": 0.9986,
    "neutral_bonus": 27,
    "neutral_tax": 7,
    "enemy_bonus": 26,
    "enemy_weak_bonus": 0.7462,
    "counter_bonus": 19,
    "pressure_max": 27,
    "pressure_divisor": 40,
    ...
    "short_hop_bonus": 0.0512,
    "short_hop_range": 17,
    "ship_weight": 1.2514,
    "high_ship_weight": 1.2514,
    "overkill": 3,
    "high_prod_extra": 2,
    "enemy_extra": 9,
    "attack_fraction": 0.9493,
    "max_attacks_per_turn": 1,
    "comet_bonus": 12,
    "staging_penalty": 11.876,
    "defense_worth_factor": 12.1412,
    "counter_attack_bonus": 39.4563,
    "production_forecast_mult": 0.8876,
