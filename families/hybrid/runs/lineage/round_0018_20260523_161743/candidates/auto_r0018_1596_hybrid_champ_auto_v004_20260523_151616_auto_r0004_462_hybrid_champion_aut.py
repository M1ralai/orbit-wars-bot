...
BASE_PARAMS = {
    ...
    "panic_reserve_mult": 0.8075,
    "neutral_bonus": 26,
    "neutral_tax": 9,
    "enemy_bonus": 24,
    "enemy_weak_bonus": 0.7855,
    "counter_bonus": 14,
    "pressure_max": 21,
    "pressure_divisor": 37,
    ...
    "high_prod_tax": 5,
    "distance_weight": 2.6643,
    "high_distance_weight": 1.6776,
    "short_hop_bonus": 0.6586,
    "short_hop_range": 16,
    "ship_weight": 1.3199,
    ...
    "high_prod_extra": 5,
    "enemy_extra": 8,
    "attack_fraction": 0.9144,
    "max_attacks_per_turn": 2,
    "comet_bonus": 13,
    "staging_penalty": 14.5756,
    "defense_worth_factor": 10.6425,
    "counter_attack_bonus": 37.8848,
    "production_forecast_mult": 1.0616,
    "evac_eta_threshold": 3.1172,
    "evac_minor_prod": 3,
    "sync_max_eta": 9.5709,
