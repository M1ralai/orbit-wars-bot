...
BASE_PARAMS = {
    ...
    "panic_reserve_mult": 1.0362,
    "neutral_bonus": 31,
    "neutral_tax": 12,
    "enemy_bonus": 29,
    "enemy_weak_bonus": 1.5537,
    "counter_bonus": 16,
    "pressure_max": 18,
    "pressure_divisor": 37,
    ...
    "high_prod_tax": 2,
    "distance_weight": 3.3274,
    "high_distance_weight": 1.7902,
    "short_hop_bonus": 0.4559,
    "short_hop_range": 16,
    "ship_weight": 1.2486,
    "high_ship_weight": 0.8695,
    "overkill": 1,
    "high_prod_extra": 5,
    "enemy_extra": 4,
    "attack_fraction": 0.8561,
    "max_attacks_per_turn": 4,
    "comet_bonus": 10,
    "staging_penalty": 10.1247,
    "defense_worth_factor": 11.0789,
    "counter_attack_bonus": 37.3026,
    "production_forecast_mult": 1.0225,
    "evac_eta_threshold": 3.035,
    "evac_minor_prod": 3,
    "sync_max_eta": 8.7991,
