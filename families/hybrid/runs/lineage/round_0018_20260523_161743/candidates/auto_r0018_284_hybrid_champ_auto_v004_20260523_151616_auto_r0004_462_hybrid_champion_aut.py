...
BASE_PARAMS = {
    ...
    "short_hop_bonus": 0.4126,
    "short_hop_range": 16,
    "ship_weight": 1.8515,
    "high_ship_weight": 0.702,
    "overkill": 8,
    "high_prod_extra": 3,
    "enemy_extra": 6,
    "attack_fraction": 0.9426,
    "max_attacks_per_turn": 1,
    "comet_bonus": 13,
    "staging_penalty": 13.4051,
    "defense_worth_factor": 11.1321,
    "counter_attack_bonus": 33.0569,
    "production_forecast_mult": 1.0616,
    "evac_eta_threshold": 2.7022,
    "evac_minor_prod": 3,
    "sync_max_eta": 6.9176,
