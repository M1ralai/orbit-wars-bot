...
BASE_PARAMS = {
    ...
    "short_hop_bonus": 0.408,
    "short_hop_range": 16,
    "ship_weight": 1.2486,
    "high_ship_weight": 0.9658,
    "overkill": 5,
    "high_prod_extra": 4,
    "enemy_extra": 6,
    "attack_fraction": 0.9615,
    "max_attacks_per_turn": 3,
    "comet_bonus": 13,
    "staging_penalty": 15.3955,
    "defense_worth_factor": 11.1321,
    "counter_attack_bonus": 40.186,
    "production_forecast_mult": 1.0616,
    "evac_eta_threshold": 2.8231,
    "evac_minor_prod": 3,
    "sync_max_eta": 8.5364,
