...
BASE_PARAMS = {
    "min_ships": 20,
    "min_reserve": 2,
    "reserve_prod_mult": 1.9757,
    "panic_reserve_mult": 1.0504,
    "neutral_bonus": 29,
    "neutral_tax": 11,
    "enemy_bonus": 25,
    "enemy_weak_bonus": 1.5502,
    "counter_bonus": 17,
    "pressure_max": 19,
    "pressure_divisor": 34,
    ...
    "short_hop_range": 16,
    "ship_weight": 1.4661,
    "high_ship_weight": 0.6184,
    "overkill": 7,
    "high_prod_extra": 3,
    "enemy_extra": 5,
    "attack_fraction": 0.8876,
    "max_attacks_per_turn": 1,
    "comet_bonus": 13,
    "staging_penalty": 11.876,
    "defense_worth_factor": 11.03,
    "counter_attack_bonus": 39.5305,
    "production_forecast_mult": 0.8591,
    "evac_eta_threshold": 3.029,
    "evac_minor_prod": 3,
    "sync_max_eta": 8.7991,
