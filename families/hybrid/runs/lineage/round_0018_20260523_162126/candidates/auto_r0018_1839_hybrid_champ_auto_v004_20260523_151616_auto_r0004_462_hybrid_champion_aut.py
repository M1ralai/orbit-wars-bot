...
BASE_PARAMS = {
    ...
    "panic_reserve_mult": 0.965,
    "neutral_bonus": 25,
    "neutral_tax": 11,
    "enemy_bonus": 28,
    "enemy_weak_bonus": 0.9975,
    "counter_bonus": 12,
    "pressure_max": 20,
    "pressure_divisor": 37,
    ...
    "high_prod_tax": 4,
    "distance_weight": 2.8332,
    "high_distance_weight": 1.8908,
    "short_hop_bonus": 0.5182,
    "short_hop_range": 16,
    "ship_weight": 1.2486,
    "high_ship_weight": 0.7342,
    "overkill": 6,
    "high_prod_extra": 2,
    "enemy_extra": 4,
    "attack_fraction": 0.9749,
    "max_attacks_per_turn": 1,
    "comet_bonus": 13,
    "staging_penalty": 11.876,
    "defense_worth_factor": 11.1321,
    "counter_attack_bonus": 36.1028,
    "production_forecast_mult": 1.0616,
    "evac_eta_threshold": 2.7668,
    "evac_minor_prod": 1,
    "sync_max_eta": 10.2584,
