...
BASE_PARAMS = {
    "min_ships": 20,
    "min_reserve": 2,
    "reserve_prod_mult": 1.8079,
    "panic_reserve_mult": 0.9007,
    "neutral_bonus": 29,
    "neutral_tax": 9,
    "enemy_bonus": 25,
    "enemy_weak_bonus": 1.4383,
    "counter_bonus": 16,
    "pressure_max": 3,
    "pressure_divisor": 40,
    ...
    "high_distance_weight": 1.8207,
    "short_hop_bonus": 0.2817,
    "short_hop_range": 16,
    "ship_weight": 1.3642,
    "high_ship_weight": 0.5278,
    "overkill": 6,
    "high_prod_extra": 4,
    "enemy_extra": 4,
    ...
    "comet_bonus": 15,
    "staging_penalty": 10.1865,
    "defense_worth_factor": 10.8923,
    "counter_attack_bonus": 38.0045,
    "production_forecast_mult": 0.9293,
    "evac_eta_threshold": 3.4708,
    "evac_minor_prod": 3,
    "sync_max_eta": 8.7991,
