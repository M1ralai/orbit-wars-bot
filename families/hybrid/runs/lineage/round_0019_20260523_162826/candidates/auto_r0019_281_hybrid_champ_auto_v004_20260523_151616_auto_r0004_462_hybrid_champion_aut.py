...
BASE_PARAMS = {
    "min_ships": 20,
    "min_reserve": 2,
    "reserve_prod_mult": 1.5637,
    "panic_reserve_mult": 0.696,
    "neutral_bonus": 25,
    "neutral_tax": 9,
    "enemy_bonus": 29,
    "enemy_weak_bonus": 0.9062,
    "counter_bonus": 17,
    "pressure_max": 58,
    "pressure_divisor": 37,
    ...
    "high_prod_tax": 1,
    "distance_weight": 2.7282,
    "high_distance_weight": 1.6058,
    "short_hop_bonus": 0.1852,
    "short_hop_range": 16,
    "ship_weight": 1.2486,
    ...
    "high_prod_extra": 3,
    "enemy_extra": 8,
    "attack_fraction": 0.9601,
    "max_attacks_per_turn": 1,
    "comet_bonus": 11,
    "staging_penalty": 9.2888,
    "defense_worth_factor": 11.1321,
    "counter_attack_bonus": 37.3682,
    "production_forecast_mult": 1.2546,
    "evac_eta_threshold": 3.1436,
    "evac_minor_prod": 3,
    "sync_max_eta": 8.7991,
