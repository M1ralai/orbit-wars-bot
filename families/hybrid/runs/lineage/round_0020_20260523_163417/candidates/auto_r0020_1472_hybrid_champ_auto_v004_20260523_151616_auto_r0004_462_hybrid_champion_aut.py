...
BASE_PARAMS = {
    ...
    "panic_reserve_mult": 0.8775,
    "neutral_bonus": 26,
    "neutral_tax": 9,
    "enemy_bonus": 26,
    "enemy_weak_bonus": 1.5282,
    "counter_bonus": 18,
    "pressure_max": 21,
    "pressure_divisor": 38,
    ...
    "high_prod_tax": 5,
    "distance_weight": 2.5255,
    "high_distance_weight": 1.9742,
    "short_hop_bonus": 0.2444,
    "short_hop_range": 16,
    "ship_weight": 1.2865,
    "high_ship_weight": 1.2865,
    "overkill": 6,
    "high_prod_extra": 5,
    "enemy_extra": 9,
    "attack_fraction": 0.8789,
    "max_attacks_per_turn": 6,
    "comet_bonus": 9,
    "staging_penalty": 10.1753,
    "defense_worth_factor": 11.1321,
    "counter_attack_bonus": 39.5376,
    "production_forecast_mult": 1.0998,
    "evac_eta_threshold": 3.1847,
    "evac_minor_prod": 3,
    "sync_max_eta": 7.4974,
