...
BASE_PARAMS = {
    ...
    "panic_reserve_mult": 0.6626,
    "neutral_bonus": 24,
    "neutral_tax": 6,
    "enemy_bonus": 28,
    "enemy_weak_bonus": 1.1972,
    "counter_bonus": 19,
    "pressure_max": 17,
    "pressure_divisor": 38,
    "production_weight": 27,
    "high_production_weight": 46,
    "high_prod_tax": 4,
    "distance_weight": 2.4926,
    "high_distance_weight": 2.063,
    ...
    "comet_bonus": 14,
    "staging_penalty": 9.8414,
    "defense_worth_factor": 12.0847,
    "counter_attack_bonus": 40.0686,
    "production_forecast_mult": 1.2461,
    "evac_eta_threshold": 2.6887,
    "evac_minor_prod": 1,
    "sync_max_eta": 10.6764,
