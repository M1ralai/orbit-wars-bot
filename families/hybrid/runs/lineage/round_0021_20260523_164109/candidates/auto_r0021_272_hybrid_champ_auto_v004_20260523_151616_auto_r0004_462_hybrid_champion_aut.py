...
BASE_PARAMS = {
    "min_ships": 20,
    "min_reserve": 3,
    "reserve_prod_mult": 1.836,
    "panic_reserve_mult": 0.663,
    "neutral_bonus": 24,
    "neutral_tax": 8,
    "enemy_bonus": 23,
    "enemy_weak_bonus": 1.0755,
    "counter_bonus": 16,
    "pressure_max": 61,
    "pressure_divisor": 38,
    ...
    "high_distance_weight": 2.1366,
    "short_hop_bonus": 0.5671,
    "short_hop_range": 16,
    "ship_weight": 1.2486,
    "high_ship_weight": 0.7119,
    "overkill": 6,
    "high_prod_extra": 3,
    "enemy_extra": 9,
    "attack_fraction": 0.9762,
    "max_attacks_per_turn": 2,
    "comet_bonus": 14,
    "staging_penalty": 12.1665,
    "defense_worth_factor": 9.4787,
    "counter_attack_bonus": 37.4617,
    "production_forecast_mult": 1.0616,
    "evac_eta_threshold": 3.4983,
    "evac_minor_prod": 3,
    "sync_max_eta": 8.372,
