...
BASE_PARAMS = {
    ...
    "panic_reserve_mult": 1.0683,
    "neutral_bonus": 25,
    "neutral_tax": 11,
    "enemy_bonus": 28,
    "enemy_weak_bonus": 1.6366,
    "counter_bonus": 16,
    "pressure_max": 19,
    "pressure_divisor": 37,
    ...
    "high_prod_tax": 4,
    "distance_weight": 2.224,
    "high_distance_weight": 2.0312,
    "short_hop_bonus": 0.2389,
    "short_hop_range": 16,
    "ship_weight": 1.4141,
    ...
    "high_prod_extra": 2,
    "enemy_extra": 12,
    "attack_fraction": 0.9797,
    "max_attacks_per_turn": 1,
    "comet_bonus": 13,
    "staging_penalty": 13.2167,
    "defense_worth_factor": 11.1321,
    "counter_attack_bonus": 36.9549,
    "production_forecast_mult": 0.8697,
    "evac_eta_threshold": 2.8614,
    "evac_minor_prod": 3,
    "sync_max_eta": 10.307,
