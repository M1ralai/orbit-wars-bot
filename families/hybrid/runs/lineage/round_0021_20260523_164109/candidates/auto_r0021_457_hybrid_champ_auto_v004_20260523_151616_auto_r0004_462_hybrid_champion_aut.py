...
BASE_PARAMS = {
    "min_ships": 20,
    "min_reserve": 3,
    "reserve_prod_mult": 1.7049,
    "panic_reserve_mult": 0.6703,
    "neutral_bonus": 27,
    "neutral_tax": 11,
    "enemy_bonus": 27,
    "enemy_weak_bonus": 1.328,
    "counter_bonus": 18,
    "pressure_max": 19,
    "pressure_divisor": 37,
    ...
    "high_prod_tax": 1,
    "distance_weight": 1.8818,
    "high_distance_weight": 1.8818,
    "short_hop_bonus": 0.0,
    "short_hop_range": 17,
    "ship_weight": 1.1264,
    "high_ship_weight": 0.5692,
    "overkill": 5,
    "high_prod_extra": 0,
    "enemy_extra": 9,
    "attack_fraction": 0.9099,
    "max_attacks_per_turn": 1,
    "comet_bonus": 13,
    "staging_penalty": 11.8926,
    "defense_worth_factor": 11.1321,
    "counter_attack_bonus": 36.9549,
    "production_forecast_mult": 1.027,
    "evac_eta_threshold": 5.597,
    "evac_minor_prod": 3,
    "sync_max_eta": 8.7991,
