...
BASE_PARAMS = {
    ...
    "panic_reserve_mult": 0.9631,
    "neutral_bonus": 30,
    "neutral_tax": 4,
    "enemy_bonus": 32,
    "enemy_weak_bonus": 1.7703,
    "counter_bonus": 16,
    "pressure_max": 31,
    "pressure_divisor": 43,
    "production_weight": 58,
    "high_production_weight": 58,
    "high_prod_tax": 10,
    "distance_weight": 2.4926,
    "high_distance_weight": 1.8556,
    "short_hop_bonus": 0.0,
    "short_hop_range": 14,
    "ship_weight": 2.001,
    ...
    "comet_bonus": 7,
    "staging_penalty": 23.7852,
    "defense_worth_factor": 8.8113,
    "counter_attack_bonus": 38.9553,
    "production_forecast_mult": 1.639,
    "evac_eta_threshold": 2.757,
    "evac_minor_prod": 1,
    "sync_max_eta": 8.7991,
