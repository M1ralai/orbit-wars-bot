...
BASE_PARAMS = {
    "min_ships": 20,
    "min_reserve": 1,
    "reserve_prod_mult": 1.1036,
    "panic_reserve_mult": 1.1168,
    "neutral_bonus": 29,
    "neutral_tax": 9,
    "enemy_bonus": 25,
    ...
    "high_prod_tax": 4,
    "distance_weight": 2.1964,
    "high_distance_weight": 1.8908,
    "short_hop_bonus": 0.0,
    "short_hop_range": 17,
    "ship_weight": 0.8654,
    "high_ship_weight": 0.6308,
    "overkill": 4,
    "high_prod_extra": 3,
    "enemy_extra": 2,
    "attack_fraction": 0.8489,
    "max_attacks_per_turn": 1,
    "comet_bonus": 15,
    "staging_penalty": 16.1899,
    "defense_worth_factor": 10.6028,
    "counter_attack_bonus": 32.0331,
    "production_forecast_mult": 1.0616,
    "evac_eta_threshold": 2.6972,
    "evac_minor_prod": 1,
    "sync_max_eta": 8.7991,
