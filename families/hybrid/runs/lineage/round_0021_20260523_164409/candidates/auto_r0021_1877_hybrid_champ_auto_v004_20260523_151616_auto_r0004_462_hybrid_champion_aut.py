...
BASE_PARAMS = {
    ...
    "panic_reserve_mult": 0.2804,
    "neutral_bonus": 31,
    "neutral_tax": 9,
    "enemy_bonus": 26,
    "enemy_weak_bonus": 1.1942,
    "counter_bonus": 16,
    "pressure_max": 25,
    "pressure_divisor": 37,
    ...
    "high_prod_tax": 0,
    "distance_weight": 1.9805,
    "high_distance_weight": 1.4972,
    "short_hop_bonus": 0.0,
    "short_hop_range": 13,
    "ship_weight": 2.7538,
    ...
    "high_prod_extra": 1,
    "enemy_extra": 0,
    "attack_fraction": 0.8824,
    "max_attacks_per_turn": 2,
    "comet_bonus": 10,
    "staging_penalty": 4.2066,
    "defense_worth_factor": 8.5401,
    "counter_attack_bonus": 48.6985,
    "production_forecast_mult": 1.0616,
    "evac_eta_threshold": 4.6131,
    "evac_minor_prod": 4,
    "sync_max_eta": 5.2046,
