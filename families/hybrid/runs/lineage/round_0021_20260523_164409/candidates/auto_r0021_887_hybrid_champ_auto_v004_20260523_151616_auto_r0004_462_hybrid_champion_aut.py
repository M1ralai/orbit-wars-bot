...
BASE_PARAMS = {
    ...
    "neutral_tax": 13,
    "enemy_bonus": 22,
    "enemy_weak_bonus": 0.591,
    "counter_bonus": 26,
    "pressure_max": 27,
    "pressure_divisor": 96,
    "production_weight": 69,
    "high_production_weight": 69,
    "high_prod_tax": 18,
    "distance_weight": 3.661,
    "high_distance_weight": 3.661,
    "short_hop_bonus": 0.7968,
    "short_hop_range": 11,
    "ship_weight": 0.6784,
    "high_ship_weight": 0.4218,
    "overkill": 6,
    "high_prod_extra": 3,
    "enemy_extra": 0,
    "attack_fraction": 0.922,
    "max_attacks_per_turn": 2,
    "comet_bonus": 16,
    "staging_penalty": 11.876,
    "defense_worth_factor": 5.7901,
    "counter_attack_bonus": 49.6194,
    "production_forecast_mult": 1.2091,
    "evac_eta_threshold": 1.891,
    "evac_minor_prod": 1,
    "sync_max_eta": 8.8743,
