...
BASE_PARAMS = {
    "min_ships": 22,
    "min_reserve": 6,
    "reserve_prod_mult": 1.1005,
    "panic_reserve_mult": 0.8678,
    "neutral_bonus": 24,
    "neutral_tax": 13,
    "enemy_bonus": 22,
    "enemy_weak_bonus": 0.5439,
    "counter_bonus": 16,
    "pressure_max": 15,
    "pressure_divisor": 76,
    "production_weight": 48,
    "high_production_weight": 70,
    "high_prod_tax": 5,
    "distance_weight": 1.9902,
    "high_distance_weight": 1.7773,
    "short_hop_bonus": 0.0056,
    "short_hop_range": 20,
    "ship_weight": 0.9335,
    "high_ship_weight": 0.6103,
    "overkill": 4,
    "high_prod_extra": 5,
    "enemy_extra": 12,
    "attack_fraction": 0.9798,
    "max_attacks_per_turn": 2,
    "comet_bonus": 15,
    "staging_penalty": 13.4564,
    "defense_worth_factor": 10.8011,
    "counter_attack_bonus": 38.4371,
    "production_forecast_mult": 1.1217,
    "evac_eta_threshold": 3.0913,
    "evac_minor_prod": 4,
    "sync_max_eta": 9.5692,
