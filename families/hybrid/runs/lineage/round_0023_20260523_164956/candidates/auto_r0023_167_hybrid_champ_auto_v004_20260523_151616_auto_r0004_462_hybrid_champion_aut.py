...
BASE_PARAMS = {
    ...
    "high_prod_tax": 7,
    "distance_weight": 2.1623,
    "high_distance_weight": 2.1602,
    "short_hop_bonus": 0.2817,
    "short_hop_range": 17,
    "ship_weight": 1.0713,
    "high_ship_weight": 0.5104,
    "overkill": 3,
    "high_prod_extra": 2,
    "enemy_extra": 12,
    "attack_fraction": 0.9686,
    "max_attacks_per_turn": 3,
    "comet_bonus": 13,
    "staging_penalty": 8.1919,
    "defense_worth_factor": 10.9513,
    "counter_attack_bonus": 36.9549,
    "production_forecast_mult": 1.0492,
    "evac_eta_threshold": 2.367,
    "evac_minor_prod": 2,
    "sync_max_eta": 10.6395,
