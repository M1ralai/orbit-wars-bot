...
BASE_PARAMS = {
    "min_ships": 18,
    "min_reserve": 4,
    "reserve_prod_mult": 0.8,
    "panic_reserve_mult": 0.8678,
    "neutral_bonus": 25,
    "neutral_tax": 9,
    "enemy_bonus": 28,
    "enemy_weak_bonus": 0.6416,
    "counter_bonus": 18,
    "pressure_max": 19,
    "pressure_divisor": 36,
    ...
    "high_prod_tax": 4,
    "distance_weight": 2.9325,
    "high_distance_weight": 1.8908,
    "short_hop_bonus": 0.837,
    "short_hop_range": 15,
    "ship_weight": 1.1214,
    ...
    "high_prod_extra": 5,
    "enemy_extra": 15,
    "attack_fraction": 0.9342,
    "max_attacks_per_turn": 2,
    "comet_bonus": 16,
    "staging_penalty": 6.5826,
    "defense_worth_factor": 7.8284,
    "counter_attack_bonus": 43.8403,
    "production_forecast_mult": 1.219,
    "evac_eta_threshold": 2.7681,
    "evac_minor_prod": 1,
    "sync_max_eta": 8.7991,
