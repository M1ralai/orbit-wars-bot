...
BASE_PARAMS = {
    "min_ships": 26,
    "min_reserve": 7,
    "reserve_prod_mult": 2.3239,
    "panic_reserve_mult": 0.8678,
    "neutral_bonus": 28,
    "neutral_tax": 9,
    "enemy_bonus": 20,
    "enemy_weak_bonus": 1.9239,
    "counter_bonus": 32,
    "pressure_max": 16,
    "pressure_divisor": 33,
    ...
    "high_prod_tax": 4,
    "distance_weight": 1.7059,
    "high_distance_weight": 1.7059,
    "short_hop_bonus": 0.2817,
    "short_hop_range": 17,
    "ship_weight": 0.4783,
    "high_ship_weight": 0.2,
    "overkill": 5,
    "high_prod_extra": 3,
    "enemy_extra": 6,
    "attack_fraction": 0.9475,
    "max_attacks_per_turn": 4,
    "comet_bonus": 1,
    "staging_penalty": 7.2762,
    "defense_worth_factor": 16.8036,
    "counter_attack_bonus": 24.862,
    "production_forecast_mult": 0.6201,
    "evac_eta_threshold": 3.2075,
    "evac_minor_prod": 4,
    "sync_max_eta": 11.0384,
