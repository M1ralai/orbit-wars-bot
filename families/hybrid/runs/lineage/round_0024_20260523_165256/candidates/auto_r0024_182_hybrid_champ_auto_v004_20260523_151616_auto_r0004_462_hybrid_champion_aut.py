...
BASE_PARAMS = {
    ...
    "panic_reserve_mult": 0.6556,
    "neutral_bonus": 24,
    "neutral_tax": 9,
    "enemy_bonus": 32,
    "enemy_weak_bonus": 1.1665,
    "counter_bonus": 16,
    "pressure_max": 23,
    "pressure_divisor": 43,
    ...
    "high_prod_tax": 6,
    "distance_weight": 2.4523,
    "high_distance_weight": 2.4523,
    "short_hop_bonus": 4.0647,
    "short_hop_range": 19,
    "ship_weight": 0.8849,
    "high_ship_weight": 0.8273,
    "overkill": 5,
    "high_prod_extra": 0,
    "enemy_extra": 4,
    "attack_fraction": 0.9596,
    "max_attacks_per_turn": 1,
    "comet_bonus": 14,
    "staging_penalty": 11.876,
    "defense_worth_factor": 10.2109,
    "counter_attack_bonus": 35.5565,
    "production_forecast_mult": 0.8785,
    "evac_eta_threshold": 3.735,
    "evac_minor_prod": 4,
    "sync_max_eta": 8.7991,
