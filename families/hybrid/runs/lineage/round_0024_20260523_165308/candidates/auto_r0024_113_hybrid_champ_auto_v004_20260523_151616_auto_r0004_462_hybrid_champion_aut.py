...
BASE_PARAMS = {
    "min_ships": 21,
    "min_reserve": 6,
    "reserve_prod_mult": 1.3924,
    "panic_reserve_mult": 0.6472,
    "neutral_bonus": 25,
    "neutral_tax": 9,
    "enemy_bonus": 28,
    "enemy_weak_bonus": 1.4302,
    "counter_bonus": 31,
    "pressure_max": 23,
    "pressure_divisor": 35,
    ...
    "short_hop_bonus": 0.1483,
    "short_hop_range": 18,
    "ship_weight": 1.146,
    "high_ship_weight": 0.4155,
    "overkill": 5,
    "high_prod_extra": 5,
    "enemy_extra": 7,
    "attack_fraction": 0.8486,
    "max_attacks_per_turn": 1,
    "comet_bonus": 13,
    "staging_penalty": 11.876,
    "defense_worth_factor": 9.6058,
    "counter_attack_bonus": 36.3843,
