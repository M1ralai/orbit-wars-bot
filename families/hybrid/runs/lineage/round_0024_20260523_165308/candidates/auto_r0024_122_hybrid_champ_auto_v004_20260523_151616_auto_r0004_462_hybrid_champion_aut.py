...
BASE_PARAMS = {
    "min_ships": 17,
    "min_reserve": 6,
    "reserve_prod_mult": 2.831,
    "panic_reserve_mult": 0.6973,
    "neutral_bonus": 29,
    "neutral_tax": 1,
    "enemy_bonus": 22,
    ...
    "high_prod_tax": 7,
    "distance_weight": 1.9347,
    "high_distance_weight": 1.9347,
    "short_hop_bonus": 0.0,
    "short_hop_range": 25,
    "ship_weight": 1.274,
    "high_ship_weight": 0.6846,
    "overkill": 4,
    "high_prod_extra": 7,
    "enemy_extra": 12,
    "attack_fraction": 0.8687,
    "max_attacks_per_turn": 2,
    "comet_bonus": 9,
    "staging_penalty": 18.5472,
    "defense_worth_factor": 15.6114,
    "counter_attack_bonus": 36.9549,
    "production_forecast_mult": 0.7425,
    "evac_eta_threshold": 1.9132,
    "evac_minor_prod": 1,
    "sync_max_eta": 13.3903,
