...
BASE_PARAMS = {
    "min_ships": 25,
    "min_reserve": 8,
    "reserve_prod_mult": 2.5079,
    "panic_reserve_mult": 0.5832,
    "neutral_bonus": 31,
    "neutral_tax": 13,
    "enemy_bonus": 26,
    ...
    "high_distance_weight": 1.4122,
    "short_hop_bonus": 0.1612,
    "short_hop_range": 13,
    "ship_weight": 1.0886,
    ...
    "high_prod_extra": 3,
    "enemy_extra": 1,
    "attack_fraction": 0.9352,
    "max_attacks_per_turn": 11,
    "comet_bonus": 19,
    "staging_penalty": 11.876,
    "defense_worth_factor": 15.0005,
    "counter_attack_bonus": 40.8383,
    "production_forecast_mult": 0.5362,
    "evac_eta_threshold": 2.7164,
    "evac_minor_prod": 1,
    "sync_max_eta": 8.7991,
