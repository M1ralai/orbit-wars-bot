...
BASE_PARAMS = {
    ...
    "panic_reserve_mult": 0.812,
    "neutral_bonus": 23,
    "neutral_tax": 9,
    "enemy_bonus": 26,
    "enemy_weak_bonus": 1.6407,
    "counter_bonus": 16,
    "pressure_max": 110,
    "pressure_divisor": 39,
    ...
    "high_prod_tax": 3,
    "distance_weight": 2.9192,
    "high_distance_weight": 2.0398,
    "short_hop_bonus": 0.0933,
    "short_hop_range": 21,
    "ship_weight": 2.9213,
    "high_ship_weight": 0.8186,
    "overkill": 5,
    "high_prod_extra": 3,
    "enemy_extra": 4,
    "attack_fraction": 0.9212,
    "max_attacks_per_turn": 3,
    "comet_bonus": 13,
    "staging_penalty": 14.4198,
    "defense_worth_factor": 10.23,
    "counter_attack_bonus": 39.3494,
    "production_forecast_mult": 0.9629,
    "evac_eta_threshold": 3.2439,
    "evac_minor_prod": 3,
    "sync_max_eta": 7.9087,
