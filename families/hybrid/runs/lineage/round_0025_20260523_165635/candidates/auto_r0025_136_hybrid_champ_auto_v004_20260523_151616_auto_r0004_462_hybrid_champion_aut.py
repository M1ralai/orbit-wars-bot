...
BASE_PARAMS = {
    ...
    "high_prod_extra": 6,
    "enemy_extra": 12,
    "attack_fraction": 0.8542,
    "max_attacks_per_turn": 1,
    "comet_bonus": 10,
    "staging_penalty": 41.3499,
    "defense_worth_factor": 10.057,
    "counter_attack_bonus": 36.9549,
    "production_forecast_mult": 0.2114,
    "evac_eta_threshold": 5.9418,
    "evac_minor_prod": 3,
    "sync_max_eta": 9.181,
