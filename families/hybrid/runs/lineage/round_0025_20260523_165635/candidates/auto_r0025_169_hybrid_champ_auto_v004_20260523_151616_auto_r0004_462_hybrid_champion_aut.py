...
BASE_PARAMS = {
    ...
    "panic_reserve_mult": 0.8986,
    "neutral_bonus": 28,
    "neutral_tax": 12,
    "enemy_bonus": 23,
    "enemy_weak_bonus": 1.3264,
    "counter_bonus": 14,
    "pressure_max": 23,
    "pressure_divisor": 32,
    ...
    "high_prod_tax": 5,
    "distance_weight": 2.5304,
    "high_distance_weight": 1.8908,
    "short_hop_bonus": 0.0,
    "short_hop_range": 15,
    "ship_weight": 1.2486,
    "high_ship_weight": 0.5142,
    "overkill": 5,
    "high_prod_extra": 1,
    "enemy_extra": 9,
    ...
    "comet_bonus": 13,
    "staging_penalty": 13.5538,
    "defense_worth_factor": 11.1321,
    "counter_attack_bonus": 31.1823,
    "production_forecast_mult": 1.2519,
    "evac_eta_threshold": 3.3264,
    "evac_minor_prod": 3,
    "sync_max_eta": 10.296,
