...
BASE_PARAMS = {
    "min_ships": 17,
    "min_reserve": 3,
    "reserve_prod_mult": 1.8025,
    "panic_reserve_mult": 0.8678,
    "neutral_bonus": 27,
    "neutral_tax": 15,
    "enemy_bonus": 23,
    "enemy_weak_bonus": 1.2428,
    "counter_bonus": 17,
    "pressure_max": 23,
    "pressure_divisor": 37,
    ...
    "short_hop_range": 18,
    "ship_weight": 1.5225,
    "high_ship_weight": 0.4507,
    "overkill": 2,
    "high_prod_extra": 6,
    "enemy_extra": 6,
    "attack_fraction": 0.9862,
    "max_attacks_per_turn": 1,
    "comet_bonus": 11,
    "staging_penalty": 11.876,
    "defense_worth_factor": 9.4575,
    "counter_attack_bonus": 41.1731,
    "production_forecast_mult": 0.9619,
    "evac_eta_threshold": 3.2156,
    "evac_minor_prod": 2,
    "sync_max_eta": 7.3807,
    "sync_min_target_prod": 1,
    "sync_min_target_ships": 64,
    "snipe_max_step": 88,
    "snipe_overkill": 1,
    "honeypot_min_prod": 4,
    "honeypot_reserve": 8,
