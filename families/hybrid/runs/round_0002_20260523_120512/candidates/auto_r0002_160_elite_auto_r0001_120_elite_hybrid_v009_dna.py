...
BASE_PARAMS = {
    "min_ships": 20,
    "min_reserve": 5,
    "reserve_prod_mult": 1.7477,
    "panic_reserve_mult": 0.1676,
    "neutral_bonus": 23,
    "neutral_tax": 0,
    "enemy_bonus": 25,
    ...
    "high_distance_weight": 1.5728,
    "short_hop_bonus": 0.0224,
    "short_hop_range": 17,
    "ship_weight": 1.1722,
    "high_ship_weight": 0.8118,
    "overkill": 0,
    "high_prod_extra": 2,
    "enemy_extra": 11,
    ...
    "comet_bonus": 9,
    "staging_penalty": 20.9668,
    "defense_worth_factor": 12.8294,
    "counter_attack_bonus": 20.318,
}
...
def agent(obs):
    ...
    for p in my_planets:
        ...
        if incoming_enemy > max_possible_defenders and earliest_eta <= 3.0:
    ...
    for src in my_planets:
        ...
        for score, target, bridge_id in scored[:3]:
            ...
            # Only hold launch for normal, non-evacuation attacks
            if not is_doomed and target_max_eta > 0.0 and tt < target_max_eta - 1.0:
                continue
