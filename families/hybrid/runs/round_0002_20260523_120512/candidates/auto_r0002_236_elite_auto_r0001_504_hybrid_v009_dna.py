...
BASE_PARAMS = {
    ...
    "high_prod_tax": 2,
    "distance_weight": 2.1736,
    "high_distance_weight": 1.9316,
    "short_hop_bonus": 0.2219,
    "short_hop_range": 16,
    "ship_weight": 1.2747,
    ...
    "comet_bonus": 8,
    "staging_penalty": 19.9819,
    "defense_worth_factor": 13.0001,
    "counter_attack_bonus": 21.262,
}
