...
BASE_PARAMS = {
    "min_ships": 20,
    "min_reserve": 2,
    "reserve_prod_mult": 1.8639,
    "panic_reserve_mult": 0.136,
    "neutral_bonus": 23,
    "neutral_tax": 4,
    "enemy_bonus": 28,
    ...
    "high_prod_tax": 5,
    "distance_weight": 2.3605,
    "high_distance_weight": 1.8758,
    "short_hop_bonus": 3.7755,
    "short_hop_range": 17,
    "ship_weight": 1.1088,
    "high_ship_weight": 0.5561,
    "overkill": 3,
    "high_prod_extra": 5,
    "enemy_extra": 10,
    ...
    "comet_bonus": 2,
    "staging_penalty": 18.6607,
    "defense_worth_factor": 12.0,
    "counter_attack_bonus": 26.273,
}
...
def agent(obs):
    ...
    for src in my_planets:
        ...
        for score, target, bridge_id in scored[:3]:
            ...
            # Only hold launch for normal attacks if the sync window is reasonable (max 10 turns)
            if not is_doomed and 0.0 < target_max_eta <= 10.0 and tt < target_max_eta - 1.0:
                continue
