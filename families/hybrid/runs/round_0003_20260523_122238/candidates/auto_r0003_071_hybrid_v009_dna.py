...
BASE_PARAMS = {
    "min_ships": 18,
    "min_reserve": 2,
    "reserve_prod_mult": 2.1465,
    "panic_reserve_mult": 0.0,
    "neutral_bonus": 31,
    "neutral_tax": 0,
    "enemy_bonus": 28,
    "enemy_weak_bonus": 0.1614,
    "counter_bonus": 0,
    "pressure_max": 0,
    "pressure_divisor": 55,
    ...
    "high_prod_tax": 0,
    "distance_weight": 2.331,
    "high_distance_weight": 2.331,
    "short_hop_bonus": 0.0,
    "short_hop_range": 16,
    "ship_weight": 0.9443,
    "high_ship_weight": 0.9443,
    "overkill": 3,
    "high_prod_extra": 1,
    "enemy_extra": 6,
    "attack_fraction": 0.6968,
    "max_attacks_per_turn": 10,
    "comet_bonus": 10,
    "staging_penalty": 15.0,
    "defense_worth_factor": 9.3127,
    "counter_attack_bonus": 23.8595,
}
