...
BASE_PARAMS = {
    ...
    "panic_reserve_mult": 0.2087,
    "neutral_bonus": 28,
    "neutral_tax": 1,
    "enemy_bonus": 26,
    "enemy_weak_bonus": 0.4593,
    "counter_bonus": 0,
    "pressure_max": 0,
    "pressure_divisor": 52,
    ...
    "high_prod_tax": 0,
    "distance_weight": 2.3691,
    "high_distance_weight": 2.2732,
    "short_hop_bonus": 0.0,
    "short_hop_range": 16,
    "ship_weight": 1.3947,
    ...
    "comet_bonus": 10,
    "staging_penalty": 19.2656,
    "defense_worth_factor": 12.097,
    "counter_attack_bonus": 20.8386,
}
