...
BASE_PARAMS = {
    "min_ships": 18,
    "min_reserve": 2,
    "reserve_prod_mult": 2.0415,
    "panic_reserve_mult": 0.213,
    "neutral_bonus": 28,
    "neutral_tax": 0,
    "enemy_bonus": 27,
    "enemy_weak_bonus": 0.3153,
    "counter_bonus": 1,
    "pressure_max": 1,
    "pressure_divisor": 52,
    ...
    "high_prod_tax": 0,
    "distance_weight": 3.9909,
    "high_distance_weight": 2.1454,
    "short_hop_bonus": 0.0,
    "short_hop_range": 16,
    "ship_weight": 1.2169,
    "high_ship_weight": 0.8579,
    "overkill": 6,
    "high_prod_extra": 0,
    "enemy_extra": 5,
    "attack_fraction": 0.8802,
    "max_attacks_per_turn": 10,
    "comet_bonus": 4,
    "staging_penalty": 30.9862,
    "defense_worth_factor": 11.5588,
    "counter_attack_bonus": 12.2816,
}
