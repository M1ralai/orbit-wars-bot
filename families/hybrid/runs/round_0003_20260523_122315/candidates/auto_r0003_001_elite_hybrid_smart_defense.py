...
BASE_PARAMS = {
    "min_ships": 17,
    "min_reserve": 5,
    "reserve_prod_mult": 3.072,
    "panic_reserve_mult": 1.157,
    "neutral_bonus": 18,
    "neutral_tax": 5,
    "enemy_bonus": 37,
    "enemy_weak_bonus": 1.2132,
    "counter_bonus": 18,
    "pressure_max": 20,
    "pressure_divisor": 22,
    ...
    "high_prod_tax": 7,
    "distance_weight": 2.5582,
    "high_distance_weight": 2.4475,
    "short_hop_bonus": 1.9971,
    "short_hop_range": 29,
    "ship_weight": 1.2854,
    ...
    "high_prod_extra": 0,
    "enemy_extra": 11,
    "attack_fraction": 0.8032,
    "max_attacks_per_turn": 5,
    "comet_bonus": 5,
    "staging_penalty": 20.0,
    "defense_worth_factor": 10.386,
    "counter_attack_bonus": 20.9292,
    "production_forecast_mult": 1.02,
    "evac_eta_threshold": 3.75,
    "evac_minor_prod": 1,
    "sync_max_eta": 12.2873,
