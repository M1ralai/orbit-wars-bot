...
BASE_PARAMS = {
    "min_ships": 14,
    "min_reserve": 6,
    "reserve_prod_mult": 2.6769,
    "panic_reserve_mult": 0.6947,
    "neutral_bonus": 27,
    "neutral_tax": 2,
    "enemy_bonus": 34,
    "enemy_weak_bonus": 0.8632,
    "counter_bonus": 11,
    "pressure_max": 10,
    "pressure_divisor": 51,
    ...
    "high_prod_tax": 4,
    "distance_weight": 3.8696,
    "high_distance_weight": 1.6971,
    "short_hop_bonus": 1.5948,
    "short_hop_range": 21,
    "ship_weight": 0.9128,
    "high_ship_weight": 0.9007,
    "overkill": 4,
    "high_prod_extra": 5,
    "enemy_extra": 12,
    "attack_fraction": 0.8375,
    "max_attacks_per_turn": 5,
    "comet_bonus": 14,
    "staging_penalty": 20.0,
    "defense_worth_factor": 12.0,
    "counter_attack_bonus": 22.9316,
    "production_forecast_mult": 1.0,
    "evac_eta_threshold": 3.708,
    "evac_minor_prod": 3,
    "sync_max_eta": 12.0,
