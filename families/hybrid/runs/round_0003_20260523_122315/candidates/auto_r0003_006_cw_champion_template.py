...
BASE_PARAMS = {
    "min_ships": 12,
    "min_reserve": 4,
    "reserve_prod_mult": 2.3253,
    "panic_reserve_mult": 0.8,
    "neutral_bonus": 23,
    "neutral_tax": 3,
    "enemy_bonus": 28,
    "enemy_weak_bonus": 0.9055,
    "counter_bonus": 10,
    "pressure_max": 13,
    "pressure_divisor": 30,
    ...
    "short_hop_bonus": 1.3335,
    "short_hop_range": 23,
    "ship_weight": 1.05,
    "high_ship_weight": 1.049,
    "overkill": 3,
    "high_prod_extra": 0,
    "enemy_extra": 7,
    "attack_fraction": 0.8585,
    "max_attacks_per_turn": 6,
    "comet_bonus": 12,
    "staging_penalty": 19.3535,
    "defense_worth_factor": 11.9285,
    "counter_attack_bonus": 21.1467,
