...
BASE_PARAMS = {
    ...
    "panic_reserve_mult": 0.0496,
    "neutral_bonus": 26,
    "neutral_tax": 2,
    "enemy_bonus": 35,
    "enemy_weak_bonus": 0.2282,
    "counter_bonus": 0,
    "pressure_max": 4,
    "pressure_divisor": 51,
    ...
    "high_prod_tax": 0,
    "distance_weight": 2.1634,
    "high_distance_weight": 2.1634,
    "short_hop_bonus": 0.5862,
    "short_hop_range": 16,
    "ship_weight": 1.073,
    "high_ship_weight": 0.7314,
    "overkill": 5,
    "high_prod_extra": 5,
    "enemy_extra": 14,
    ...
    "comet_bonus": 5,
    "staging_penalty": 22.6356,
    "defense_worth_factor": 12.0,
    "counter_attack_bonus": 29.4738,
    "production_forecast_mult": 1.0,
    "evac_eta_threshold": 3.4589,
    "evac_minor_prod": 2,
    "sync_max_eta": 11.5833,
