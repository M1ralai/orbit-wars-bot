...
BASE_PARAMS = {
    "min_ships": 17,
    "min_reserve": 7,
    "reserve_prod_mult": 2.5691,
    "panic_reserve_mult": 0.8,
    "neutral_bonus": 26,
    "neutral_tax": 2,
    "enemy_bonus": 32,
    "enemy_weak_bonus": 0.4211,
    "counter_bonus": 11,
    "pressure_max": 8,
    "pressure_divisor": 30,
    ...
    "high_prod_tax": 0,
    "distance_weight": 2.5183,
    "high_distance_weight": 2.1706,
    "short_hop_bonus": 1.3642,
    "short_hop_range": 22,
    "ship_weight": 1.05,
    ...
    "high_prod_extra": 2,
    "enemy_extra": 7,
    "attack_fraction": 0.8182,
    "max_attacks_per_turn": 7,
    "comet_bonus": 12,
    "staging_penalty": 17.5932,
    "defense_worth_factor": 9.0844,
    "counter_attack_bonus": 25.0,
    "production_forecast_mult": 1.2242,
    "evac_eta_threshold": 3.523,
    "evac_minor_prod": 3,
    "sync_max_eta": 13.3644,
    "sync_min_target_prod": 3,
    "sync_min_target_ships": 47,
    "snipe_max_step": 110,
    "snipe_overkill": 3,
    "honeypot_min_prod": 5,
    "honeypot_reserve": 3,
