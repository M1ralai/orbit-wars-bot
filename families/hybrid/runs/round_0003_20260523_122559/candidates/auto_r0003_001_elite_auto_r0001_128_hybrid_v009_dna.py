...
BASE_PARAMS = {
    "min_ships": 19,
    "min_reserve": 4,
    "reserve_prod_mult": 1.9323,
    "panic_reserve_mult": 0.0434,
    "neutral_bonus": 32,
    "neutral_tax": 2,
    "enemy_bonus": 26,
    "enemy_weak_bonus": 1.2061,
    "counter_bonus": 6,
    "pressure_max": 0,
    "pressure_divisor": 46,
    ...
    "short_hop_range": 18,
    "ship_weight": 1.2434,
    "high_ship_weight": 1.0741,
    "overkill": 5,
    "high_prod_extra": 1,
    "enemy_extra": 7,
    "attack_fraction": 0.5383,
    "max_attacks_per_turn": 8,
    "comet_bonus": 12,
    "staging_penalty": 17.8696,
    "defense_worth_factor": 12.0,
    "counter_attack_bonus": 25.0,
    "production_forecast_mult": 0.8369,
    "evac_eta_threshold": 3.5701,
    "evac_minor_prod": 2,
    "sync_max_eta": 12.3577,
