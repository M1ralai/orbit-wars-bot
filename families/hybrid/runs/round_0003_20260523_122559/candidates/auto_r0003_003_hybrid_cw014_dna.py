...
BASE_PARAMS = {
    "min_ships": 15,
    "min_reserve": 3,
    "reserve_prod_mult": 3.3977,
    "panic_reserve_mult": 0.8304,
    "neutral_bonus": 1,
    "neutral_tax": 15,
    "enemy_bonus": 47,
    "enemy_weak_bonus": 0.2404,
    "counter_bonus": 0,
    "pressure_max": 29,
    "pressure_divisor": 27,
    ...
    "high_prod_tax": 2,
    "distance_weight": 2.6337,
    "high_distance_weight": 2.6337,
    "short_hop_bonus": 0.1405,
    "short_hop_range": 16,
    "ship_weight": 0.7234,
    "high_ship_weight": 0.7234,
    "overkill": 8,
    "high_prod_extra": 1,
    "enemy_extra": 11,
    "attack_fraction": 0.7669,
    "max_attacks_per_turn": 2,
    "comet_bonus": 14,
    "staging_penalty": 14.6449,
    "defense_worth_factor": 10.0,
    "counter_attack_bonus": 20.0,
    "production_forecast_mult": 1.1256,
    "evac_eta_threshold": 4.2164,
    "evac_minor_prod": 1,
    "sync_max_eta": 10.4694,
