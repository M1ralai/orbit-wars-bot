...
BASE_PARAMS = {
    "min_ships": 14,
    "min_reserve": 2,
    "reserve_prod_mult": 1.9351,
    "panic_reserve_mult": 0.6007,
    "neutral_bonus": 24,
    "neutral_tax": 0,
    "enemy_bonus": 22,
    ...
    "high_prod_tax": 0,
    "distance_weight": 2.0608,
    "high_distance_weight": 1.8264,
    "short_hop_bonus": 0.4219,
    "short_hop_range": 22,
    "ship_weight": 1.0367,
    "high_ship_weight": 0.7723,
    "overkill": 7,
    "high_prod_extra": 0,
    "enemy_extra": 6,
    "attack_fraction": 0.8796,
    "max_attacks_per_turn": 7,
    "comet_bonus": 11,
    "staging_penalty": 12.3501,
    "defense_worth_factor": 11.0018,
    "counter_attack_bonus": 20.0,
    "production_forecast_mult": 1.0,
    "evac_eta_threshold": 3.7305,
    "evac_minor_prod": 3,
    "sync_max_eta": 10.9664,
