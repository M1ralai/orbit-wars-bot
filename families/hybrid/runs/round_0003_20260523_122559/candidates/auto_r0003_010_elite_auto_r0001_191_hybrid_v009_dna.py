...
BASE_PARAMS = {
    "min_ships": 19,
    "min_reserve": 2,
    "reserve_prod_mult": 2.327,
    "panic_reserve_mult": 0.3076,
    "neutral_bonus": 32,
    "neutral_tax": 7,
    "enemy_bonus": 24,
    ...
    "high_prod_tax": 1,
    "distance_weight": 1.8663,
    "high_distance_weight": 1.8663,
    "short_hop_bonus": 1.9255,
    "short_hop_range": 16,
    "ship_weight": 1.0145,
    ...
    "high_prod_extra": 5,
    "enemy_extra": 2,
    "attack_fraction": 0.9041,
    "max_attacks_per_turn": 9,
    "comet_bonus": 3,
    "staging_penalty": 18.3878,
    "defense_worth_factor": 12.0,
    "counter_attack_bonus": 24.9305,
    "production_forecast_mult": 1.149,
    "evac_eta_threshold": 3.6603,
    "evac_minor_prod": 3,
    "sync_max_eta": 12.0,
