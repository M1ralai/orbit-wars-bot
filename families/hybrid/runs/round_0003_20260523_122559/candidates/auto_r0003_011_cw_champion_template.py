...
BASE_PARAMS = {
    "min_ships": 11,
    "min_reserve": 5,
    "reserve_prod_mult": 2.4223,
    "panic_reserve_mult": 0.9206,
    "neutral_bonus": 24,
    "neutral_tax": 4,
    "enemy_bonus": 34,
    "enemy_weak_bonus": 0.5052,
    "counter_bonus": 12,
    "pressure_max": 10,
    "pressure_divisor": 27,
    ...
    "high_prod_tax": 2,
    "distance_weight": 3.6062,
    "high_distance_weight": 2.0,
    "short_hop_bonus": 1.2973,
    "short_hop_range": 24,
    "ship_weight": 1.05,
    ...
    "high_prod_extra": 5,
    "enemy_extra": 10,
    "attack_fraction": 0.9554,
    "max_attacks_per_turn": 8,
    "comet_bonus": 9,
    "staging_penalty": 19.2233,
    "defense_worth_factor": 12.0,
    "counter_attack_bonus": 27.6208,
    "production_forecast_mult": 1.0,
    "evac_eta_threshold": 3.4564,
    "evac_minor_prod": 1,
    "sync_max_eta": 13.0233,
