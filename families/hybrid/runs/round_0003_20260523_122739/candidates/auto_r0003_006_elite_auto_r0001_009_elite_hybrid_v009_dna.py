...
BASE_PARAMS = {
    "min_ships": 19,
    "min_reserve": 2,
    "reserve_prod_mult": 2.7897,
    "panic_reserve_mult": 0.0687,
    "neutral_bonus": 32,
    "neutral_tax": 2,
    "enemy_bonus": 30,
    "enemy_weak_bonus": 3.7713,
    "counter_bonus": 30,
    "pressure_max": 3,
    "pressure_divisor": 48,
    ...
    "high_prod_tax": 0,
    "distance_weight": 2.4255,
    "high_distance_weight": 2.3672,
    "short_hop_bonus": 0.1894,
    "short_hop_range": 16,
    "ship_weight": 1.3314,
    ...
    "high_prod_extra": 5,
    "enemy_extra": 7,
    "attack_fraction": 0.8484,
    "max_attacks_per_turn": 9,
    "comet_bonus": 4,
    "staging_penalty": 16.4283,
    "defense_worth_factor": 12.0,
    "counter_attack_bonus": 28.2448,
    "production_forecast_mult": 0.7725,
    "evac_eta_threshold": 3.75,
    "evac_minor_prod": 3,
    "sync_max_eta": 13.5353,
