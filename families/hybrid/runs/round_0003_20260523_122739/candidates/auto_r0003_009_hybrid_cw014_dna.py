...
BASE_PARAMS = {
    "min_ships": 20,
    "min_reserve": 4,
    "reserve_prod_mult": 3.4831,
    "panic_reserve_mult": 0.5659,
    "neutral_bonus": 3,
    "neutral_tax": 19,
    "enemy_bonus": 43,
    ...
    "high_prod_tax": 14,
    "distance_weight": 3.101,
    "high_distance_weight": 2.9884,
    "short_hop_bonus": 0.3124,
    "short_hop_range": 16,
    "ship_weight": 1.0481,
    "high_ship_weight": 0.822,
    "overkill": 8,
    "high_prod_extra": 0,
    "enemy_extra": 14,
    "attack_fraction": 0.8794,
    "max_attacks_per_turn": 5,
    "comet_bonus": 14,
    "staging_penalty": 17.7426,
    "defense_worth_factor": 10.0741,
    "counter_attack_bonus": 22.8,
    "production_forecast_mult": 0.9671,
    "evac_eta_threshold": 3.6879,
    "evac_minor_prod": 1,
    "sync_max_eta": 13.2656,
