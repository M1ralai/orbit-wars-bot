...
BASE_PARAMS = {
    "min_ships": 20,
    "min_reserve": 5,
    "reserve_prod_mult": 2.6229,
    "panic_reserve_mult": 0.0,
    "neutral_bonus": 26,
    "neutral_tax": 0,
    "enemy_bonus": 26,
    "enemy_weak_bonus": 0.4552,
    "counter_bonus": 30,
    "pressure_max": 0,
    "pressure_divisor": 51,
    ...
    "high_prod_tax": 0,
    "distance_weight": 2.4677,
    "high_distance_weight": 2.0259,
    "short_hop_bonus": 0.2653,
    "short_hop_range": 16,
    "ship_weight": 1.1224,
    "high_ship_weight": 1.083,
    "overkill": 5,
    "high_prod_extra": 5,
    "enemy_extra": 5,
    "attack_fraction": 0.8317,
    "max_attacks_per_turn": 10,
    "comet_bonus": 4,
    "staging_penalty": 20.1866,
    "defense_worth_factor": 11.6915,
    "counter_attack_bonus": 22.1669,
    "production_forecast_mult": 0.8082,
    "evac_eta_threshold": 3.4916,
    "evac_minor_prod": 3,
    "sync_max_eta": 13.5355,
