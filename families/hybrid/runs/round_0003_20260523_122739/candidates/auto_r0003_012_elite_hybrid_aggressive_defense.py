...
BASE_PARAMS = {
    "min_ships": 20,
    "min_reserve": 6,
    "reserve_prod_mult": 4.3335,
    "panic_reserve_mult": 0.8735,
    "neutral_bonus": 24,
    "neutral_tax": 3,
    "enemy_bonus": 36,
    "enemy_weak_bonus": 0.7649,
    "counter_bonus": 9,
    "pressure_max": 8,
    "pressure_divisor": 30,
    ...
    "high_prod_tax": 4,
    "distance_weight": 2.3,
    "high_distance_weight": 1.8343,
    "short_hop_bonus": 0.8967,
    "short_hop_range": 25,
    "ship_weight": 1.05,
    "high_ship_weight": 0.9389,
    "overkill": 5,
    "high_prod_extra": 1,
    "enemy_extra": 13,
    "attack_fraction": 0.9335,
    "max_attacks_per_turn": 5,
    "comet_bonus": 11,
    "staging_penalty": 20.0,
    "defense_worth_factor": 10.836,
    "counter_attack_bonus": 24.4491,
    "production_forecast_mult": 1.0,
    "evac_eta_threshold": 4.0475,
    "evac_minor_prod": 2,
    "sync_max_eta": 12.0,
