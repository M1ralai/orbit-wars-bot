...
BASE_PARAMS = {
    "min_ships": 17,
    "min_reserve": 4,
    "reserve_prod_mult": 2.0895,
    "panic_reserve_mult": 0.9591,
    "neutral_bonus": 26,
    "neutral_tax": 0,
    "enemy_bonus": 34,
    ...
    "high_prod_tax": 10,
    "distance_weight": 2.3,
    "high_distance_weight": 2.0919,
    "short_hop_bonus": 1.3497,
    "short_hop_range": 22,
    "ship_weight": 1.0455,
    "high_ship_weight": 0.8956,
    "overkill": 3,
    "high_prod_extra": 0,
    "enemy_extra": 7,
    "attack_fraction": 0.9091,
    "max_attacks_per_turn": 8,
    "comet_bonus": 11,
    "staging_penalty": 19.5476,
    "defense_worth_factor": 12.8077,
    "counter_attack_bonus": 25.0,
    "production_forecast_mult": 1.182,
    "evac_eta_threshold": 4.1453,
    "evac_minor_prod": 1,
    "sync_max_eta": 12.0,
