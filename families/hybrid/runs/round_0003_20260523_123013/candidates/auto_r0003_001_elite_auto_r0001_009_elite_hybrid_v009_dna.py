...
BASE_PARAMS = {
    "min_ships": 18,
    "min_reserve": 6,
    "reserve_prod_mult": 2.2014,
    "panic_reserve_mult": 0.1246,
    "neutral_bonus": 28,
    "neutral_tax": 1,
    "enemy_bonus": 26,
    "enemy_weak_bonus": 0.2627,
    "counter_bonus": 27,
    "pressure_max": 2,
    "pressure_divisor": 50,
    ...
    "high_prod_tax": 0,
    "distance_weight": 2.3784,
    "high_distance_weight": 2.2953,
    "short_hop_bonus": 0.0,
    "short_hop_range": 18,
    "ship_weight": 1.2521,
    "high_ship_weight": 1.1047,
    "overkill": 8,
    "high_prod_extra": 5,
    "enemy_extra": 6,
    "attack_fraction": 0.9194,
    "max_attacks_per_turn": 8,
    "comet_bonus": 9,
    "staging_penalty": 20.0,
    "defense_worth_factor": 13.1524,
    "counter_attack_bonus": 25.0,
    "production_forecast_mult": 0.9043,
    "evac_eta_threshold": 3.5132,
    "evac_minor_prod": 1,
    "sync_max_eta": 10.356,
