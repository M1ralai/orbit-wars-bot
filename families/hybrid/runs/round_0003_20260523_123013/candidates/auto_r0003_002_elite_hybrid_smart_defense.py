...
BASE_PARAMS = {
    "min_ships": 16,
    "min_reserve": 5,
    "reserve_prod_mult": 2.792,
    "panic_reserve_mult": 1.0,
    "neutral_bonus": 17,
    "neutral_tax": 7,
    "enemy_bonus": 41,
    "enemy_weak_bonus": 1.2182,
    "counter_bonus": 26,
    "pressure_max": 23,
    "pressure_divisor": 32,
    ...
    "high_prod_extra": 0,
    "enemy_extra": 9,
    "attack_fraction": 0.8584,
    "max_attacks_per_turn": 4,
    "comet_bonus": 11,
    "staging_penalty": 22.5242,
    "defense_worth_factor": 13.1874,
    "counter_attack_bonus": 28.6119,
    "production_forecast_mult": 0.5982,
    "evac_eta_threshold": 3.3831,
    "evac_minor_prod": 3,
    "sync_max_eta": 11.5507,
