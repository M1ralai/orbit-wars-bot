...
BASE_PARAMS = {
    "min_ships": 14,
    "min_reserve": 5,
    "reserve_prod_mult": 2.5399,
    "panic_reserve_mult": 1.5954,
    "neutral_bonus": 25,
    "neutral_tax": 0,
    "enemy_bonus": 30,
    "enemy_weak_bonus": 0.1421,
    "counter_bonus": 8,
    "pressure_max": 7,
    "pressure_divisor": 43,
    ...
    "high_prod_tax": 1,
    "distance_weight": 2.2,
    "high_distance_weight": 2.0943,
    "short_hop_bonus": 0.5,
    "short_hop_range": 21,
    "ship_weight": 1.306,
    "high_ship_weight": 1.053,
    "overkill": 5,
    "high_prod_extra": 0,
    "enemy_extra": 8,
    "attack_fraction": 0.967,
    "max_attacks_per_turn": 10,
    "comet_bonus": 9,
    "staging_penalty": 12.529,
    "defense_worth_factor": 10.0,
    "counter_attack_bonus": 21.3788,
    "production_forecast_mult": 1.702,
    "evac_eta_threshold": 3.75,
    "evac_minor_prod": 3,
    "sync_max_eta": 11.5636,
