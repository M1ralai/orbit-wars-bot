...
BASE_PARAMS = {
    "min_ships": 14,
    "min_reserve": 5,
    "reserve_prod_mult": 1.9277,
    "panic_reserve_mult": 0.8,
    "neutral_bonus": 26,
    "neutral_tax": 3,
    "enemy_bonus": 35,
    "enemy_weak_bonus": 0.7011,
    "counter_bonus": 6,
    "pressure_max": 6,
    "pressure_divisor": 33,
    ...
    "high_prod_tax": 2,
    "distance_weight": 2.6357,
    "high_distance_weight": 2.0,
    "short_hop_bonus": 1.3262,
    "short_hop_range": 28,
    "ship_weight": 1.05,
    "high_ship_weight": 0.6396,
    "overkill": 6,
    "high_prod_extra": 1,
    "enemy_extra": 13,
    "attack_fraction": 0.9548,
    "max_attacks_per_turn": 6,
    "comet_bonus": 9,
    "staging_penalty": 20.0,
    "defense_worth_factor": 14.2049,
    "counter_attack_bonus": 26.3343,
    "production_forecast_mult": 0.7889,
    "evac_eta_threshold": 3.75,
    "evac_minor_prod": 3,
    "sync_max_eta": 11.7151,
