...
BASE_PARAMS = {
    ...
    "panic_reserve_mult": 0.0893,
    "neutral_bonus": 32,
    "neutral_tax": 5,
    "enemy_bonus": 26,
    "enemy_weak_bonus": 1.4746,
    "counter_bonus": 9,
    "pressure_max": 0,
    "pressure_divisor": 50,
    ...
    "high_prod_tax": 0,
    "distance_weight": 2.468,
    "high_distance_weight": 2.468,
    "short_hop_bonus": 0.0,
    "short_hop_range": 18,
    "ship_weight": 1.2434,
    "high_ship_weight": 1.1054,
    "overkill": 2,
    "high_prod_extra": 2,
    "enemy_extra": 6,
    "attack_fraction": 0.903,
    "max_attacks_per_turn": 10,
    "comet_bonus": 11,
    "staging_penalty": 20.564,
    "defense_worth_factor": 12.0,
    "counter_attack_bonus": 27.7637,
    "production_forecast_mult": 0.8317,
    "evac_eta_threshold": 4.1325,
    "evac_minor_prod": 3,
    "sync_max_eta": 12.0,
