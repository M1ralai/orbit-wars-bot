...
BASE_PARAMS = {
    "min_ships": 16,
    "min_reserve": 5,
    "reserve_prod_mult": 3.3947,
    "panic_reserve_mult": 0.6584,
    "neutral_bonus": 0,
    "neutral_tax": 16,
    "enemy_bonus": 42,
    "enemy_weak_bonus": 0.3257,
    "counter_bonus": 0,
    "pressure_max": 37,
    "pressure_divisor": 24,
    "production_weight": 19,
    "high_production_weight": 43,
    "high_prod_tax": 2,
    "distance_weight": 2.7814,
    "high_distance_weight": 2.7814,
    "short_hop_bonus": 0.2618,
    "short_hop_range": 16,
    "ship_weight": 0.9165,
    ...
    "high_prod_extra": 0,
    "enemy_extra": 14,
    "attack_fraction": 0.8137,
    "max_attacks_per_turn": 4,
    "comet_bonus": 14,
    "staging_penalty": 14.73,
    "defense_worth_factor": 10.0,
    "counter_attack_bonus": 20.9183,
    "production_forecast_mult": 1.0,
    "evac_eta_threshold": 4.6647,
    "evac_minor_prod": 3,
    "sync_max_eta": 10.7284,
