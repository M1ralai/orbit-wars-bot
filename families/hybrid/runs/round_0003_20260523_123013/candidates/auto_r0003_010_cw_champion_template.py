...
BASE_PARAMS = {
    ...
    "panic_reserve_mult": 0.6353,
    "neutral_bonus": 25,
    "neutral_tax": 2,
    "enemy_bonus": 34,
    "enemy_weak_bonus": 0.1925,
    "counter_bonus": 12,
    "pressure_max": 9,
    "pressure_divisor": 31,
    ...
    "high_prod_tax": 4,
    "distance_weight": 2.5413,
    "high_distance_weight": 2.0879,
    "short_hop_bonus": 1.2,
    "short_hop_range": 28,
    "ship_weight": 1.1692,
    "high_ship_weight": 0.9405,
    "overkill": 5,
    "high_prod_extra": 2,
    "enemy_extra": 13,
    "attack_fraction": 0.8213,
    "max_attacks_per_turn": 10,
    "comet_bonus": 10,
    "staging_penalty": 21.7838,
    "defense_worth_factor": 12.0,
    "counter_attack_bonus": 25.0,
    "production_forecast_mult": 1.1411,
    "evac_eta_threshold": 3.9595,
    "evac_minor_prod": 3,
    "sync_max_eta": 10.4205,
