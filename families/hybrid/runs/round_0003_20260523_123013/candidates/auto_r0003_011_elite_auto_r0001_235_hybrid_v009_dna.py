...
BASE_PARAMS = {
    "min_ships": 19,
    "min_reserve": 8,
    "reserve_prod_mult": 2.4855,
    "panic_reserve_mult": 0.0,
    "neutral_bonus": 32,
    "neutral_tax": 2,
    "enemy_bonus": 20,
    "enemy_weak_bonus": 0.4424,
    "counter_bonus": 1,
    "pressure_max": 0,
    "pressure_divisor": 45,
    ...
    "high_prod_tax": 1,
    "distance_weight": 2.1555,
    "high_distance_weight": 2.1555,
    "short_hop_bonus": 0.0,
    "short_hop_range": 22,
    "ship_weight": 1.3721,
    "high_ship_weight": 1.2688,
    "overkill": 4,
    "high_prod_extra": 0,
    "enemy_extra": 5,
    "attack_fraction": 0.8951,
    "max_attacks_per_turn": 10,
    "comet_bonus": 11,
    "staging_penalty": 20.0,
    "defense_worth_factor": 13.2976,
    "counter_attack_bonus": 25.0,
    "production_forecast_mult": 1.204,
    "evac_eta_threshold": 4.2701,
    "evac_minor_prod": 2,
    "sync_max_eta": 10.8513,
