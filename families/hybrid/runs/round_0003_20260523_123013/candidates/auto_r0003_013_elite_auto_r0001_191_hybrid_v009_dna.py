...
BASE_PARAMS = {
    "min_ships": 20,
    "min_reserve": 8,
    "reserve_prod_mult": 3.4607,
    "panic_reserve_mult": 0.1642,
    "neutral_bonus": 32,
    "neutral_tax": 2,
    "enemy_bonus": 27,
    "enemy_weak_bonus": 0.2573,
    "counter_bonus": 0,
    "pressure_max": 1,
    "pressure_divisor": 49,
    ...
    "high_prod_tax": 1,
    "distance_weight": 1.8524,
    "high_distance_weight": 1.8524,
    "short_hop_bonus": 2.2979,
    "short_hop_range": 20,
    "ship_weight": 1.2427,
    "high_ship_weight": 1.0986,
    "overkill": 7,
    "high_prod_extra": 5,
    "enemy_extra": 2,
    "attack_fraction": 0.9119,
    "max_attacks_per_turn": 8,
    "comet_bonus": 5,
    "staging_penalty": 17.1346,
    "defense_worth_factor": 12.0,
    "counter_attack_bonus": 21.3093,
    "production_forecast_mult": 1.0,
    "evac_eta_threshold": 3.75,
    "evac_minor_prod": 3,
    "sync_max_eta": 12.2681,
