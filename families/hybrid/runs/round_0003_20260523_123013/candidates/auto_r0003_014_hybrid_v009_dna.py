...
BASE_PARAMS = {
    "min_ships": 20,
    "min_reserve": 2,
    "reserve_prod_mult": 2.1214,
    "panic_reserve_mult": 0.0,
    "neutral_bonus": 28,
    "neutral_tax": 2,
    "enemy_bonus": 56,
    "enemy_weak_bonus": 0.1877,
    "counter_bonus": 0,
    "pressure_max": 0,
    "pressure_divisor": 52,
    ...
    "high_distance_weight": 1.9952,
    "short_hop_bonus": 0.3023,
    "short_hop_range": 16,
    "ship_weight": 1.0294,
    "high_ship_weight": 0.7741,
    "overkill": 4,
    "high_prod_extra": 3,
    "enemy_extra": 8,
    ...
    "comet_bonus": 13,
    "staging_penalty": 17.6858,
    "defense_worth_factor": 10.0,
    "counter_attack_bonus": 24.4153,
    "production_forecast_mult": 1.1288,
    "evac_eta_threshold": 4.1263,
    "evac_minor_prod": 1,
    "sync_max_eta": 12.0,
