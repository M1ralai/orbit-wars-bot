...
BASE_PARAMS = {
    "min_ships": 18,
    "min_reserve": 7,
    "reserve_prod_mult": 2.6981,
    "panic_reserve_mult": 0.8,
    "neutral_bonus": 26,
    "neutral_tax": 3,
    "enemy_bonus": 34,
    "enemy_weak_bonus": 0.5944,
    "counter_bonus": 14,
    "pressure_max": 9,
    "pressure_divisor": 29,
    ...
    "high_prod_tax": 3,
    "distance_weight": 2.2445,
    "high_distance_weight": 2.236,
    "short_hop_bonus": 1.3276,
    "short_hop_range": 24,
    "ship_weight": 0.8968,
    ...
    "high_prod_extra": 4,
    "enemy_extra": 8,
    "attack_fraction": 0.507,
    "max_attacks_per_turn": 5,
    "comet_bonus": 9,
    "staging_penalty": 20.0,
    "defense_worth_factor": 12.0,
    "counter_attack_bonus": 25.0,
    "production_forecast_mult": 0.9091,
    "evac_eta_threshold": 3.255,
    "evac_minor_prod": 1,
    "sync_max_eta": 13.8837,
