...
BASE_PARAMS = {
    "min_ships": 20,
    "min_reserve": 2,
    "reserve_prod_mult": 1.506,
    "panic_reserve_mult": 0.0,
    "neutral_bonus": 32,
    "neutral_tax": 5,
    "enemy_bonus": 24,
    "enemy_weak_bonus": 1.0819,
    "counter_bonus": 9,
    "pressure_max": 0,
    "pressure_divisor": 42,
    ...
    "high_prod_tax": 0,
    "distance_weight": 2.595,
    "high_distance_weight": 2.5268,
    "short_hop_bonus": 0.0,
    "short_hop_range": 16,
    "ship_weight": 1.2078,
    "high_ship_weight": 0.8456,
    "overkill": 0,
    "high_prod_extra": 5,
    "enemy_extra": 11,
    ...
    "comet_bonus": 8,
    "staging_penalty": 11.0219,
    "defense_worth_factor": 12.0,
    "counter_attack_bonus": 21.4918,
    "production_forecast_mult": 0.7695,
    "evac_eta_threshold": 3.75,
    "evac_minor_prod": 3,
    "sync_max_eta": 12.2396,
