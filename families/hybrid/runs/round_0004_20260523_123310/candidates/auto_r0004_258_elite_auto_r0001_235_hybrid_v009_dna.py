...
BASE_PARAMS = {
    ...
    "high_prod_tax": 3,
    "distance_weight": 2.7305,
    "high_distance_weight": 2.6972,
    "short_hop_bonus": 0.0,
    "short_hop_range": 16,
    "ship_weight": 1.395,
    "high_ship_weight": 1.1599,
    "overkill": 4,
    "high_prod_extra": 3,
    "enemy_extra": 3,
    "attack_fraction": 0.9358,
    "max_attacks_per_turn": 10,
    "comet_bonus": -6,
    "staging_penalty": 20.0,
    "defense_worth_factor": 13.4365,
    "counter_attack_bonus": 20.3028,
    "production_forecast_mult": 0.8129,
    "evac_eta_threshold": 3.8932,
    "evac_minor_prod": 3,
    "sync_max_eta": 8.4329,
