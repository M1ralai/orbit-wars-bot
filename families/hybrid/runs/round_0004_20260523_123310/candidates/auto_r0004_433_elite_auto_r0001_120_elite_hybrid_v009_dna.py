...
BASE_PARAMS = {
    ...
    "high_prod_tax": 3,
    "distance_weight": 1.9629,
    "high_distance_weight": 1.6445,
    "short_hop_bonus": 0.1378,
    "short_hop_range": 17,
    "ship_weight": 1.37,
    "high_ship_weight": 0.8311,
    "overkill": 0,
    "high_prod_extra": 5,
    "enemy_extra": 10,
    "attack_fraction": 0.7056,
    "max_attacks_per_turn": 8,
    "comet_bonus": 7,
    "staging_penalty": 20.0,
    "defense_worth_factor": 12.0,
    "counter_attack_bonus": 27.6484,
    "production_forecast_mult": 1.0,
    "evac_eta_threshold": 3.75,
    "evac_minor_prod": 1,
    "sync_max_eta": 13.4165,
