...
BASE_PARAMS = {
    ...
    "high_prod_tax": 0,
    "distance_weight": 2.5312,
    "high_distance_weight": 2.2544,
    "short_hop_bonus": 0.0,
    "short_hop_range": 36,
    "ship_weight": 1.3851,
    ...
    "high_prod_extra": 1,
    "enemy_extra": 7,
    "attack_fraction": 0.8714,
    "max_attacks_per_turn": 10,
    "comet_bonus": 10,
    "staging_penalty": 17.3731,
    "defense_worth_factor": 12.0,
    "counter_attack_bonus": 22.2001,
    "production_forecast_mult": 1.0784,
    "evac_eta_threshold": 3.9514,
    "evac_minor_prod": 3,
    "sync_max_eta": 10.8979,
