...
BASE_PARAMS = {
    ...
    "high_prod_extra": 0,
    "enemy_extra": 10,
    "attack_fraction": 0.9222,
    "max_attacks_per_turn": 3,
    "comet_bonus": 18,
    "staging_penalty": 21.5996,
    "defense_worth_factor": 11.8802,
    "counter_attack_bonus": 25.0,
    "production_forecast_mult": 1.2257,
    "evac_eta_threshold": 4.1691,
    "evac_minor_prod": 3,
    "sync_max_eta": 11.9377,
