...
BASE_PARAMS = {
    "min_ships": 20,
    "min_reserve": 2,
    "reserve_prod_mult": 2.4084,
    "panic_reserve_mult": 0.0,
    "neutral_bonus": 26,
    "neutral_tax": 3,
    "enemy_bonus": 25,
    "enemy_weak_bonus": 0.1363,
    "counter_bonus": 29,
    "pressure_max": 0,
    "pressure_divisor": 52,
    ...
    "high_prod_tax": 0,
    "distance_weight": 3.7085,
    "high_distance_weight": 2.139,
    "short_hop_bonus": 0.0792,
    "short_hop_range": 16,
    "ship_weight": 1.2586,
    ...
    "high_prod_extra": 5,
    "enemy_extra": 6,
    "attack_fraction": 0.9611,
    "max_attacks_per_turn": 6,
    "comet_bonus": 6,
    "staging_penalty": 19.0908,
    "defense_worth_factor": 12.0,
    "counter_attack_bonus": 26.0972,
    "production_forecast_mult": 1.0,
    "evac_eta_threshold": 3.3458,
    "evac_minor_prod": 3,
    "sync_max_eta": 13.3414,
