...
BASE_PARAMS = {
    "min_ships": 18,
    "min_reserve": 2,
    "reserve_prod_mult": 2.5278,
    "panic_reserve_mult": 0.1145,
    "neutral_bonus": 7,
    "neutral_tax": 4,
    "enemy_bonus": 27,
    ...
    "high_prod_tax": 0,
    "distance_weight": 1.9594,
    "high_distance_weight": 1.9594,
    "short_hop_bonus": 1.8523,
    "short_hop_range": 17,
    "ship_weight": 1.3927,
    "high_ship_weight": 0.6824,
    "overkill": 8,
    "high_prod_extra": 4,
    "enemy_extra": 6,
    "attack_fraction": 0.9523,
    "max_attacks_per_turn": 10,
    "comet_bonus": 1,
    "staging_penalty": 19.1647,
    "defense_worth_factor": 12.0,
    "counter_attack_bonus": 27.1826,
    "production_forecast_mult": 0.9799,
