...
BASE_PARAMS = {
    "min_ships": 18,
    "min_reserve": 2,
    "reserve_prod_mult": 2.052,
    "panic_reserve_mult": 0.0,
    "neutral_bonus": 31,
    "neutral_tax": 0,
    "enemy_bonus": 27,
    "enemy_weak_bonus": 0.4341,
    "counter_bonus": 0,
    "pressure_max": 0,
    "pressure_divisor": 51,
    ...
    "high_prod_tax": 0,
    "distance_weight": 2.4714,
    "high_distance_weight": 2.4714,
    "short_hop_bonus": 0.0,
    "short_hop_range": 17,
    "ship_weight": 0.5537,
    "high_ship_weight": 0.5537,
    "overkill": 3,
    "high_prod_extra": 5,
    "enemy_extra": 5,
    ...
    "comet_bonus": 9,
    "staging_penalty": 12.9609,
    "defense_worth_factor": 11.6395,
    "counter_attack_bonus": 20.0,
    "production_forecast_mult": 1.0448,
    "evac_eta_threshold": 3.779,
    "evac_minor_prod": 1,
    "sync_max_eta": 11.9966,
