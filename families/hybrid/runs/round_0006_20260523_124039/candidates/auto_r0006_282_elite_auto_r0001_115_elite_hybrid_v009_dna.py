...
BASE_PARAMS = {
    "min_ships": 13,
    "min_reserve": 4,
    "reserve_prod_mult": 1.549,
    "panic_reserve_mult": 0.0,
    "neutral_bonus": 32,
    "neutral_tax": 0,
    "enemy_bonus": 29,
    "enemy_weak_bonus": 0.0869,
    "counter_bonus": 0,
    "pressure_max": 1,
    "pressure_divisor": 49,
    ...
    "short_hop_range": 16,
    "ship_weight": 1.1205,
    "high_ship_weight": 0.9953,
    "overkill": 0,
    "high_prod_extra": 4,
    "enemy_extra": 14,
    "attack_fraction": 0.9202,
    "max_attacks_per_turn": 10,
    "comet_bonus": 5,
    "staging_penalty": 17.3369,
    "defense_worth_factor": 10.762,
    "counter_attack_bonus": 21.8441,
    "production_forecast_mult": 1.0756,
    "evac_eta_threshold": 3.2411,
    "evac_minor_prod": 1,
    "sync_max_eta": 12.0,
