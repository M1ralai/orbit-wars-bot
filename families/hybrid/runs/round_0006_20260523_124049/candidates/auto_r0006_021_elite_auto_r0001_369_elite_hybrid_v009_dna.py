...
BASE_PARAMS = {
    "min_ships": 20,
    "min_reserve": 2,
    "reserve_prod_mult": 2.047,
    "panic_reserve_mult": 0.0,
    "neutral_bonus": 24,
    "neutral_tax": 5,
    "enemy_bonus": 26,
    "enemy_weak_bonus": 0.0878,
    "counter_bonus": 0,
    "pressure_max": 0,
    "pressure_divisor": 44,
    ...
    "high_prod_tax": 0,
    "distance_weight": 1.6211,
    "high_distance_weight": 1.6211,
    "short_hop_bonus": 0.0,
    "short_hop_range": 16,
    "ship_weight": 1.311,
    ...
    "high_prod_extra": 3,
    "enemy_extra": 13,
    "attack_fraction": 0.8808,
    "max_attacks_per_turn": 10,
    "comet_bonus": 7,
    "staging_penalty": 21.2463,
    "defense_worth_factor": 12.0,
    "counter_attack_bonus": 25.0,
    "production_forecast_mult": 1.0711,
    "evac_eta_threshold": 4.1336,
    "evac_minor_prod": 3,
    "sync_max_eta": 12.0,
