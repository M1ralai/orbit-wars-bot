...
BASE_PARAMS = {
    ...
    "short_hop_bonus": 0.2109,
    "short_hop_range": 16,
    "ship_weight": 0.9916,
    "high_ship_weight": 0.9916,
    "overkill": 3,
    "high_prod_extra": 5,
    "enemy_extra": 4,
    "attack_fraction": 0.8844,
    "max_attacks_per_turn": 6,
    "comet_bonus": 9,
    "staging_penalty": 20.3814,
    "defense_worth_factor": 12.0,
    "counter_attack_bonus": 23.6399,
    "production_forecast_mult": 1.1062,
    "evac_eta_threshold": 4.1608,
    "evac_minor_prod": 2,
    "sync_max_eta": 12.7795,
