...
BASE_PARAMS = {
    ...
    "short_hop_bonus": 0.1435,
    "short_hop_range": 16,
    "ship_weight": 0.7068,
    "high_ship_weight": 0.7068,
    "overkill": 1,
    "high_prod_extra": 4,
    "enemy_extra": 11,
    "attack_fraction": 0.9471,
    "max_attacks_per_turn": 8,
    "comet_bonus": 11,
    "staging_penalty": 17.3429,
    "defense_worth_factor": 12.0,
    "counter_attack_bonus": 26.0927,
    "production_forecast_mult": 0.8718,
    "evac_eta_threshold": 4.0763,
    "evac_minor_prod": 1,
    "sync_max_eta": 11.7387,
