...
BASE_PARAMS = {
    "min_ships": 15,
    "min_reserve": 3,
    "reserve_prod_mult": 2.0857,
    "panic_reserve_mult": 0.6618,
    "neutral_bonus": 21,
    "neutral_tax": 5,
    "enemy_bonus": 69,
    "enemy_weak_bonus": 0.8328,
    "counter_bonus": 12,
    "pressure_max": 10,
    "pressure_divisor": 36,
    ...
    "high_prod_tax": 1,
    "distance_weight": 1.9997,
    "high_distance_weight": 1.75,
    "short_hop_bonus": 1.1304,
    "short_hop_range": 26,
    "ship_weight": 0.8678,
    ...
    "comet_bonus": 8,
    "staging_penalty": 12.0003,
    "defense_worth_factor": 10.0,
    "counter_attack_bonus": 20.0,
    "production_forecast_mult": 1.1472,
    "evac_eta_threshold": 3.75,
    "evac_minor_prod": 3,
    "sync_max_eta": 13.1073,
