...
BASE_PARAMS = {
    "min_ships": 20,
    "min_reserve": 2,
    "reserve_prod_mult": 1.7787,
    "panic_reserve_mult": 0.0639,
    "neutral_bonus": 32,
    "neutral_tax": 2,
    "enemy_bonus": 23,
    ...
    "high_prod_tax": 0,
    "distance_weight": 1.9434,
    "high_distance_weight": 1.9434,
    "short_hop_bonus": 0.0,
    "short_hop_range": 17,
    "ship_weight": 1.0644,
    "high_ship_weight": 0.6626,
    "overkill": 3,
    "high_prod_extra": 3,
    "enemy_extra": 7,
    "attack_fraction": 0.8499,
    "max_attacks_per_turn": 9,
    "comet_bonus": 9,
    "staging_penalty": 20.0,
    "defense_worth_factor": 11.8587,
    "counter_attack_bonus": 29.642,
    "production_forecast_mult": 1.1766,
    "evac_eta_threshold": 3.75,
    "evac_minor_prod": 1,
    "sync_max_eta": 13.4958,
