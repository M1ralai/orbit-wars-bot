...
BASE_PARAMS = {
    ...
    "high_prod_tax": 5,
    "distance_weight": 2.0211,
    "high_distance_weight": 1.7736,
    "short_hop_bonus": 0.2183,
    "short_hop_range": 17,
    "ship_weight": 0.7223,
    "high_ship_weight": 0.7223,
    "overkill": 1,
    "high_prod_extra": 5,
    "enemy_extra": 12,
    "attack_fraction": 0.9681,
    "max_attacks_per_turn": 10,
    "comet_bonus": 10,
    "staging_penalty": 29.5513,
    "defense_worth_factor": 12.0,
    "counter_attack_bonus": 28.9325,
    "production_forecast_mult": 0.8097,
