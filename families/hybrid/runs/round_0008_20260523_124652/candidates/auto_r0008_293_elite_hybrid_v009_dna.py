...
BASE_PARAMS = {
    ...
    "high_prod_extra": 2,
    "enemy_extra": 5,
    "attack_fraction": 0.8938,
    "max_attacks_per_turn": 8,
    "comet_bonus": 13,
    "staging_penalty": 16.6868,
    "defense_worth_factor": 12.4477,
    "counter_attack_bonus": 25.0,
    "production_forecast_mult": 1.032,
    "evac_eta_threshold": 3.8773,
    "evac_minor_prod": 3,
    "sync_max_eta": 12.0,
