...
BASE_PARAMS = {
    ...
    "high_prod_tax": 2,
    "distance_weight": 1.7998,
    "high_distance_weight": 1.7998,
    "short_hop_bonus": 0.2281,
    "short_hop_range": 16,
    "ship_weight": 1.2573,
    "high_ship_weight": 0.799,
    "overkill": 5,
    "high_prod_extra": 3,
    "enemy_extra": 11,
    ...
    "counter_attack_bonus": 30.0477,
    "production_forecast_mult": 1.1345,
    "evac_eta_threshold": 3.5496,
    "evac_minor_prod": 1,
    "sync_max_eta": 10.7009,
...
def detect_counter_attack_targets(enemy_fleets, my_planets):
...
def agent(obs):
    ...
    counter_attack_targets = detect_counter_attack_targets(enemy_fleets, my_planets)
