...
BASE_PARAMS = {
    "min_ships": 19,
    "min_reserve": 2,
    "reserve_prod_mult": 2.7223,
    "panic_reserve_mult": 0.2496,
    "neutral_bonus": 30,
    "neutral_tax": 1,
    "enemy_bonus": 18,
    ...
    "high_prod_tax": 1,
    "distance_weight": 1.8532,
    "high_distance_weight": 1.8532,
    "short_hop_bonus": 1.8523,
    "short_hop_range": 19,
    "ship_weight": 1.2077,
    "high_ship_weight": 0.828,
    "overkill": 3,
    "high_prod_extra": 3,
    "enemy_extra": 4,
    ...
    "comet_bonus": 4,
    "staging_penalty": 19.553,
    "defense_worth_factor": 13.3474,
    "counter_attack_bonus": 23.9093,
    "production_forecast_mult": 1.1097,
    "evac_eta_threshold": 3.2875,
    "evac_minor_prod": 1,
    "sync_max_eta": 12.0,
...
def fleet_hit_eta(fleet, planet, step=None, orbit_table=None, max_steps=120, eta_cache=None):
    ...
    if perp < planet["radius"] + 2.5:
        return remember(dist_xy(fx, fy, px, py) / speed)
    return remember(None)
