...
BASE_PARAMS = {
    ...
    "panic_reserve_mult": 0.0408,
    "neutral_bonus": 29,
    "neutral_tax": 0,
    "enemy_bonus": 26,
    "enemy_weak_bonus": 0.13,
    "counter_bonus": 0,
    "pressure_max": 2,
    "pressure_divisor": 49,
    ...
    "high_prod_tax": 0,
    "distance_weight": 2.3008,
    "high_distance_weight": 2.1939,
    "short_hop_bonus": 0.1381,
    "short_hop_range": 16,
    "ship_weight": 0.9628,
    "high_ship_weight": 0.6871,
    "overkill": 3,
    "high_prod_extra": 2,
    "enemy_extra": 2,
    ...
    "comet_bonus": 8,
    "staging_penalty": 16.8004,
    "defense_worth_factor": 11.8772,
    "counter_attack_bonus": 23.92,
    "production_forecast_mult": 1.2313,
    "evac_eta_threshold": 3.2423,
    "evac_minor_prod": 1,
    "sync_max_eta": 10.3224,
    "sync_min_target_prod": 3,
    "sync_min_target_ships": 19,
    "snipe_max_step": 112,
    "snipe_overkill": 6,
    "honeypot_min_prod": 4,
    "honeypot_reserve": 6,
