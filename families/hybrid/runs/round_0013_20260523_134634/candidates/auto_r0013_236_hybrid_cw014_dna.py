...
BASE_PARAMS = {
    "min_ships": 15,
    "min_reserve": 6,
    "reserve_prod_mult": 3.0487,
    "panic_reserve_mult": 0.8416,
    "neutral_bonus": 20,
    "neutral_tax": 13,
    "enemy_bonus": 45,
    ...
    "high_distance_weight": 2.4771,
    "short_hop_bonus": 0.0,
    "short_hop_range": 19,
    "ship_weight": 0.7536,
    "high_ship_weight": 0.5745,
    "overkill": 8,
    "high_prod_extra": 5,
    "enemy_extra": 14,
    "attack_fraction": 0.8363,
    "max_attacks_per_turn": 1,
    "comet_bonus": 18,
    "staging_penalty": 17.9877,
    "defense_worth_factor": 10.0,
    "counter_attack_bonus": 24.5035,
    "production_forecast_mult": 1.0481,
    "evac_eta_threshold": 3.75,
    "evac_minor_prod": 3,
    "sync_max_eta": 10.4883,
