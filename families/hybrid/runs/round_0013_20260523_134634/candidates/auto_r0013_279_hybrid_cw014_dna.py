...
BASE_PARAMS = {
    "min_ships": 15,
    "min_reserve": 4,
    "reserve_prod_mult": 3.0904,
    "panic_reserve_mult": 0.7916,
    "neutral_bonus": 0,
    "neutral_tax": 14,
    "enemy_bonus": 48,
    "enemy_weak_bonus": 0.1377,
    "counter_bonus": 0,
    "pressure_max": 34,
    "pressure_divisor": 25,
    ...
    "high_prod_tax": 17,
    "distance_weight": 2.4659,
    "high_distance_weight": 2.4659,
    "short_hop_bonus": 0.0,
    "short_hop_range": 20,
    "ship_weight": 0.7664,
    "high_ship_weight": 0.6422,
    "overkill": 8,
    "high_prod_extra": 5,
    "enemy_extra": 14,
    "attack_fraction": 0.7479,
    "max_attacks_per_turn": 5,
    "comet_bonus": 14,
    "staging_penalty": 11.5859,
    "defense_worth_factor": 11.7578,
    "counter_attack_bonus": 23.0074,
    "production_forecast_mult": 1.1196,
    "evac_eta_threshold": 3.5524,
    "evac_minor_prod": 3,
    "sync_max_eta": 11.0687,
    "sync_min_target_prod": 4,
    "sync_min_target_ships": 15,
    "snipe_max_step": 110,
    "snipe_overkill": 3,
    "honeypot_min_prod": 5,
    "honeypot_reserve": 6,
