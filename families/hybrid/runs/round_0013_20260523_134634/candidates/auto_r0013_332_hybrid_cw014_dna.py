...
BASE_PARAMS = {
    ...
    "high_prod_extra": 2,
    "enemy_extra": 14,
    "attack_fraction": 0.7373,
    "max_attacks_per_turn": 4,
    "comet_bonus": 12,
    "staging_penalty": 15.8948,
    "defense_worth_factor": 10.289,
    "counter_attack_bonus": 23.0468,
    "production_forecast_mult": 0.9159,
    "evac_eta_threshold": 3.571,
    "evac_minor_prod": 3,
    "sync_max_eta": 13.424,
