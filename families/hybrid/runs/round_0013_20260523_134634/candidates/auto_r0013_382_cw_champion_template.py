...
BASE_PARAMS = {
    "min_ships": 12,
    "min_reserve": 3,
    "reserve_prod_mult": 2.6337,
    "panic_reserve_mult": 0.745,
    "neutral_bonus": 24,
    "neutral_tax": 4,
    "enemy_bonus": 36,
    "enemy_weak_bonus": 0.8194,
    "counter_bonus": 10,
    "pressure_max": 12,
    "pressure_divisor": 31,
    ...
    "high_prod_tax": 4,
    "distance_weight": 2.3,
    "high_distance_weight": 2.1434,
    "short_hop_bonus": 0.8477,
    "short_hop_range": 24,
    "ship_weight": 1.05,
    ...
    "high_prod_extra": 4,
    "enemy_extra": 8,
    "attack_fraction": 0.877,
    "max_attacks_per_turn": 2,
    "comet_bonus": 14,
    "staging_penalty": 20.8116,
    "defense_worth_factor": 13.3703,
    "counter_attack_bonus": 25.0,
    "production_forecast_mult": 1.0822,
    "evac_eta_threshold": 3.3233,
    "evac_minor_prod": 1,
    "sync_max_eta": 10.9237,
