...
BASE_PARAMS = {
    "min_ships": 17,
    "min_reserve": 5,
    "reserve_prod_mult": 2.693,
    "panic_reserve_mult": 0.6562,
    "neutral_bonus": 1,
    "neutral_tax": 10,
    "enemy_bonus": 46,
    ...
    "high_prod_tax": 21,
    "distance_weight": 2.9659,
    "high_distance_weight": 2.7814,
    "short_hop_bonus": 0.8027,
    "short_hop_range": 16,
    "ship_weight": 0.9165,
    ...
    "high_prod_extra": 3,
    "enemy_extra": 14,
    "attack_fraction": 0.8315,
    "max_attacks_per_turn": 1,
    "comet_bonus": 14,
    "staging_penalty": 20.0,
    "defense_worth_factor": 13.3827,
    "counter_attack_bonus": 25.1645,
    "production_forecast_mult": 1.0,
    "evac_eta_threshold": 3.3218,
    "evac_minor_prod": 2,
    "sync_max_eta": 11.6382,
